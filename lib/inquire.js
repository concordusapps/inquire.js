(function (_ps) {
    ...
    _ps.Data_Traversable = (function (module) {
        ...
        var sequence = function (__dict_Applicative_12) {
            return function (__dict_Traversable_13) {
                return function (_1) {
                    return traverse(__dict_Traversable_13)(__dict_Applicative_12)(_ps.Prelude.id(_ps.Prelude.categoryArr({})))(_1);
                    throw "Failed pattern match";
                };
            };
        };
    ...
    _ps.Data_Tuple = (function (module) {
        ...
        var showTuple_show = function (__dict_Show_14) {
            return function (__dict_Show_15) {
                return function (_1) {
                    return "Tuple(" + _ps.Prelude.show(__dict_Show_14)(_1.values[0]) + ", " + _ps.Prelude.show(__dict_Show_15)(_1.values[1]) + ")";
                    throw "Failed pattern match";
                };
            };
        };
    ...
    _ps.Debug_Trace = (function (module) {
        ...
        var print = function (__dict_Show_16) {
            return function (_1) {
                return trace(_ps.Prelude.show(__dict_Show_16)(_1));
                throw "Failed pattern match";
            };
        };
        module.print = print;
    ...
    _ps.Control_Monad = (function (module) {
        var when = function (__dict_Monad_17) {
            return function (_1) {
                ...
                return function (_2) {
                    ...
                    if (!_1) {
                        return _ps.Prelude["return"](__dict_Monad_17)({});
                    };
                    throw "Failed pattern match";
                };
            };
        ...
        module.when = when;
        var sequence = function (__dict_Monad_18) {
            return function (_1) {
                if (!Array.isArray(_1)) {
                    throw "Array expected";
                };
                return (function (_2) {
                    ...
                    if (_2.length > 0) {
                        var _4 = _2.slice(1);
                        return _ps.Prelude[">>="](__dict_Monad_18)(_2[0])(function (a) {
                            return _ps.Prelude[">>="](__dict_Monad_18)(sequence(__dict_Monad_18)(_4))(function (as) {
                                if (!Array.isArray(as)) {
                                    throw "Array expected";
                                };
        ...
        module.sequence = sequence;
        var zipWithM = function (__dict_Monad_19) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return function (_3) {
                        ...
                        return (function (_4, _5, _6) {
                            return sequence(__dict_Monad_19)(_ps.Data_Array.zipWith(_4)(_5)(_6));
                            throw "Failed pattern match";
                        })(_1, _2, _3);
                    };
                };
        ...
        var replicateM = function (__dict_Monad_20) {
            return function (_1) {
                ...
                return function (_2) {
                    ...
                    return _ps.Prelude[">>="](__dict_Monad_20)(_2)(function (a) {
                        return _ps.Prelude[">>="](__dict_Monad_20)(replicateM(__dict_Monad_20)(_1 - 1)(_2))(function (as) {
                            if (!Array.isArray(as)) {
                                throw "Array expected";
                            };
        ...
        var mapM = function (__dict_Monad_21) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return (function (_3, _4) {
                        ...
                        if (_4.length > 0) {
                            var _6 = _4.slice(1);
                            return _ps.Prelude[">>="](__dict_Monad_21)(_3(_4[0]))(function (b) {
                                return _ps.Prelude[">>="](__dict_Monad_21)(mapM(__dict_Monad_21)(_3)(_6))(function (bs) {
                                    if (!Array.isArray(bs)) {
                                        throw "Array expected";
                                    };
                                    return _ps.Prelude["return"](__dict_Monad_21)(_ps.Data_Array[":"](b)(bs));
                                });
                            });
                        };
                        throw "Failed pattern match";
        ...
        module.mapM = mapM;
        var join = function (__dict_Monad_22) {
            return function (_1) {
                return _ps.Prelude[">>="](__dict_Monad_22)(_1)(function (m) {
                    return m;
                });
                throw "Failed pattern match";
            };
        ...
        module.join = join;
        var foldM = function (__dict_Monad_23) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    return function (_3) {
                        ...
                        return (function (_4, _5, _6) {
                            if (_6.length === 0) {
                                return _ps.Prelude["return"](__dict_Monad_23)(_5);
                            };
                            if (_6.length > 0) {
                                var _8 = _6.slice(1);
                                return _ps.Prelude[">>="](__dict_Monad_23)(_4(_5)(_6[0]))(function (a$prime) {
                                    return foldM(__dict_Monad_23)(_4)(a$prime)(_8);
                                });
                            };
                            throw "Failed pattern match";
                        })(_1, _2, _3);
        ...
        module.foldM = foldM;
        var $greater$eq$greater = function (__dict_Monad_24) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return function (_3) {
                        return _ps.Prelude[">>="](__dict_Monad_24)(_1(_3))(function (b) {
                            return _2(b);
                        });
                        throw "Failed pattern match";
                    };
        ...
        var $less$eq$less = function (__dict_Monad_25) {
            return _ps.Prelude.flip($greater$eq$greater(__dict_Monad_25));
        };
        module["<=<"] = $less$eq$less;
        return module;
    })(_ps.Control_Monad || {});
    ...
    _ps.Inquire = (function (module) {
        ...
        var gen = function (__dict_Show_32) {
            return function (__dict_Show_33) {
                return function (_1) {
                    return _ps.Prelude.show(showInquire(__dict_Show_32)(__dict_Show_33))(_1);
                    throw "Failed pattern match";
                };
            };
        };
        ...
        var eqInquire_$div$eq = function (__dict_Eq_36) {
            return function (__dict_Eq_37) {
                return function (_1) {
                    return function (_2) {
                        return !_ps.Prelude["=="](eqInquire(__dict_Eq_36)(__dict_Eq_37))(_1)(_2);
                        throw "Failed pattern match";
                    };
                };
            };
        ...
        module.and = and;
        var absorb = function (__dict_Eq_38) {
                ...
                return function (_1) {
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[1]).ctor === "Inquire.AND") {
                            if ((_1.values[2]).ctor === "Inquire.Junc") {
                                if (((_1.values[2]).values[1]).ctor === "Inquire.OR") {
                                    if (_ps.Prelude["=="](eqInquire(__dict_Eq_38)(__dict_Eq_39))(_1.values[0])((_1.values[2]).values[0])) {
                                        return _1.values[0];
                                    };
                                };
                            };
    ...
    _ps.Inquire_Combinators = (function (module) {
                        ...
                        return function (_3) {
                            return (function (_4, _5, _6) {
                                if (_6.ctor === "Inquire.Junc") {
                                    return (function (_1) {
                                        return _4(_6.values[2])(_1) ? _ps.Inquire.Junc(remove$prime(__dict_Eq_40)(__dict_Eq_41)(_4)(_5)(_6.values[0]))(_6.values[1])(_6.values[2]) : _ps.Inquire.Junc(_6.values[0])(_6.values[1])(_1);
                                        throw "Failed pattern match";
                                    })(remove$prime(__dict_Eq_40)(__dict_Eq_41)(_4)(_5)(_6.values[2]));
                                };
                                if (_6.ctor === "Inquire.Wrap") {
                                    return _ps.Inquire.Wrap(_6.values[0])(remove$prime(__dict_Eq_40)(__dict_Eq_41)(_4)(_5)(_6.values[1]));
                                };
                                if (_ps.Prelude["=="](_ps.Inquire.eqInquire(__dict_Eq_40)(__dict_Eq_41))(_5)(_6)) {
        ...
        var findI = function (__dict_Eq_46) {
            return function (_1) {
                return function (_2) {
                    if (_2.ctor === "Inquire.Pred") {
                    ...
                    if (_2.ctor === "Inquire.Junc") {
                        return _ps.Data_Maybe.maybe(findI(__dict_Eq_46)(_1)(_2.values[0]))(_ps.Data_Maybe.Just)(findI(__dict_Eq_46)(_1)(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Wrap") {
                        return findI(__dict_Eq_46)(_1)(_2.values[1]);
                    };
                    return _ps.Data_Maybe.Nothing;
                    throw "Failed pattern match";
                };
    ...
    _ps.Inquire_Zipper = (function (module) {
        var Top = function (value0) {
            return {
                ctor: "Inquire.Zipper.Top", 
                values: [ value0 ]
            };
        };
        module.Top = Top;
        var Zipper = function (value0) {
            return function (value1) {
                return {
                    ctor: "Inquire.Zipper.Zipper", 
                    values: [ value0, value1 ]
                };
            };
        };
        module.Zipper = Zipper;
        var Cont = function (value0) {
            return {
                ctor: "Inquire.Zipper.Cont", 
                values: [ value0 ]
            };
        };
        module.Cont = Cont;
        var reset = function (_1) {
            return (function (_2) {
                return (function (_1) {
                    return (_1.values[0]).runCont(_ps.Prelude.id(_ps.Prelude.categoryArr({})));
                    throw "Failed pattern match";
                })(_2);
                throw "Failed pattern match";
            })(_1);
        ...
        module.shift = shift;
        var monadCont_$greater$greater$eq = function (_1) {
            return function (_2) {
                if (typeof _2 !== "function") {
                    throw "function expected";
                };
                return (function (_3, _4) {
                    return Cont({
                        runCont: function (k) {
                            ...
                            return (_3.values[0]).runCont(function (a) {
                                return (function (_1) {
                                    return (_1.values[0]).runCont(k);
                                    throw "Failed pattern match";
                                })(_4(a));
                            });
                        }
        ...
        module.monadCont_$greater$greater$eq = monadCont_$greater$greater$eq;
        var monadCont_$$return = function (_1) {
            return Cont({
                runCont: function (f) {
                    if (typeof f !== "function") {
                        throw "function expected";
        ...
        module.monadCont_$$return = monadCont_$$return;
        var monadCont = function (_1) {
            if (typeof _1 !== "object") {
                throw "object expected";
            };
            return {
                $$return: monadCont_$$return, 
                $greater$greater$eq: monadCont_$greater$greater$eq
            };
        };
        module.monadCont = monadCont;
        return module;
    })(_ps.Inquire_Zipper || {});
