(function (_ps) {
    ...
    _ps.Data_Tuple = (function (module) {
        ...
        var showTuple_show = function (__dict_Show_16) {
            return function (__dict_Show_17) {
                return function (_1) {
                    return "Tuple(" + _ps.Prelude.show(__dict_Show_16)(_1.values[0]) + ", " + _ps.Prelude.show(__dict_Show_17)(_1.values[1]) + ")";
                    throw "Failed pattern match";
                };
            };
        };
    ...
    _ps.Debug_Trace = (function (module) {
        ...
        var print = function (__dict_Show_18) {
            return function (_1) {
                return trace(_ps.Prelude.show(__dict_Show_18)(_1));
                throw "Failed pattern match";
            };
        };
        module.print = print;
    ...
    _ps.Control_Monad = (function (module) {
        var when = function (__dict_Monad_19) {
            return function (_1) {
                ...
                return function (_2) {
                    ...
                    if (!_1) {
                        return _ps.Prelude["return"](__dict_Monad_19)({});
                    };
                    throw "Failed pattern match";
                };
            };
        ...
        module.when = when;
        var sequence = function (__dict_Monad_20) {
            return function (_1) {
                if (!Array.isArray(_1)) {
                    throw "Array expected";
                };
                return (function (_2) {
                    if (_2.length === 0) {
                        return _ps.Prelude["return"](__dict_Monad_20)([  ]);
                    };
                    if (_2.length > 0) {
                        var _4 = _2.slice(1);
                        return _ps.Prelude[">>="](__dict_Monad_20)(_2[0])(function (a) {
                            return _ps.Prelude[">>="](__dict_Monad_20)(sequence(__dict_Monad_20)(_4))(function (as) {
                                if (!Array.isArray(as)) {
                                    throw "Array expected";
                                };
                                return _ps.Prelude["return"](__dict_Monad_20)(_ps.Data_Array[":"](a)(as));
                            });
                        });
                    };
                    throw "Failed pattern match";
        ...
        module.sequence = sequence;
        var zipWithM = function (__dict_Monad_21) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return function (_3) {
                        ...
                        return (function (_4, _5, _6) {
                            return sequence(__dict_Monad_21)(_ps.Data_Array.zipWith(_4)(_5)(_6));
                            throw "Failed pattern match";
                        })(_1, _2, _3);
                    };
                };
        ...
        var replicateM = function (__dict_Monad_22) {
            return function (_1) {
                if (typeof _1 !== "number") {
                    throw "number expected";
                };
                return function (_2) {
                    ...
                    return _ps.Prelude[">>="](__dict_Monad_22)(_2)(function (a) {
                        return _ps.Prelude[">>="](__dict_Monad_22)(replicateM(__dict_Monad_22)(_1 - 1)(_2))(function (as) {
                            if (!Array.isArray(as)) {
                                throw "Array expected";
                            };
        ...
        var mapM = function (__dict_Monad_23) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return (function (_3, _4) {
                        ...
                        if (_4.length > 0) {
                            var _6 = _4.slice(1);
                            return _ps.Prelude[">>="](__dict_Monad_23)(_3(_4[0]))(function (b) {
                                return _ps.Prelude[">>="](__dict_Monad_23)(mapM(__dict_Monad_23)(_3)(_6))(function (bs) {
                                    if (!Array.isArray(bs)) {
                                        throw "Array expected";
                                    };
                                    return _ps.Prelude["return"](__dict_Monad_23)(_ps.Data_Array[":"](b)(bs));
                                });
                            });
                        };
                        throw "Failed pattern match";
        ...
        module.mapM = mapM;
        var join = function (__dict_Monad_24) {
            return function (_1) {
                return _ps.Prelude[">>="](__dict_Monad_24)(_1)(function (m) {
                    return m;
                });
                throw "Failed pattern match";
            };
            ...
            return function (_1) {
                ...
                return function (_2) {
                    return function (_3) {
                        ...
                        return (function (_4, _5, _6) {
                            if (_6.length === 0) {
                                return _ps.Prelude["return"](__dict_Monad_25)(_5);
                            };
                            if (_6.length > 0) {
                                var _8 = _6.slice(1);
                                return _ps.Prelude[">>="](__dict_Monad_25)(_4(_5)(_6[0]))(function (a$prime) {
                                    return foldM(__dict_Monad_25)(_4)(a$prime)(_8);
                                });
                            };
                            throw "Failed pattern match";
                        })(_1, _2, _3);
        ...
        module.foldM = foldM;
        var $greater$eq$greater = function (__dict_Monad_26) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return function (_3) {
                        return _ps.Prelude[">>="](__dict_Monad_26)(_1(_3))(function (b) {
                            return _2(b);
                        });
                        throw "Failed pattern match";
                    };
        ...
        var $less$eq$less = function (__dict_Monad_27) {
            return _ps.Prelude.flip($greater$eq$greater(__dict_Monad_27));
        };
        module["<=<"] = $less$eq$less;
        return module;
    })(_ps.Control_Monad || {});
    ...
    _ps.Inquire = (function (module) {
        ...
        var traversableInquire = function (_1) {
            ...
            return {
                traverse: function (__dict_Applicative_29) {
                    return traversableInquire_traverse(__dict_Applicative_29);
                }
            };
        };
        module.traversableInquire = traversableInquire;
        var traversableInquire_traverse = function (__dict_Applicative_28) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    if (_2.ctor === "Inquire.EmptyAnd") {
                        return _ps.Prelude.pure(__dict_Applicative_28)(EmptyAnd);
                    };
                    if (_2.ctor === "Inquire.EmptyOr") {
                        return _ps.Prelude.pure(__dict_Applicative_28)(EmptyOr);
                    };
                    if (_2.ctor === "Inquire.Pred") {
                        return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_28))(Pred(_2.values[0])(_2.values[1]))(_1(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Junc") {
                        return _ps.Prelude["<*>"](__dict_Applicative_28)(_ps.Prelude["<*>"](__dict_Applicative_28)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_28))(Junc)(_ps.Data_Traversable.traverse(traversableInquire({}))(__dict_Applicative_28)(_1)(_2.values[0])))(_ps.Prelude.pure(__dict_Applicative_28)(_2.values[1])))(_ps.Data_Traversable.traverse(traversableInquire({}))(__dict_Applicative_28)(_1)(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Wrap") {
                        return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_28))(Wrap(_2.values[0]))(_ps.Data_Traversable.traverse(traversableInquire({}))(__dict_Applicative_28)(_1)(_2.values[1]));
                    };
                    throw "Failed pattern match";
                };
            };
        ...
        var showInquire_show = function (__dict_Show_30) {
            return function (__dict_Show_31) {
                return function (_1) {
                    ...
                    if (_1.ctor === "Inquire.Pred") {
                        return _ps.Prelude.show(__dict_Show_30)(_1.values[0]) + _ps.Prelude.show(showRel({}))(_1.values[1]) + _ps.Prelude.show(__dict_Show_31)(_1.values[2]);
                    };
                    if (_1.ctor === "Inquire.Junc") {
                        return "(" + _ps.Prelude.show(showInquire(__dict_Show_30)(__dict_Show_31))(_1.values[0]) + ")" + _ps.Prelude.show(showJuncOp({}))(_1.values[1]) + "(" + _ps.Prelude.show(showInquire(__dict_Show_30)(__dict_Show_31))(_1.values[2]) + ")";
                    };
                    if (_1.ctor === "Inquire.Wrap") {
                        return _ps.Prelude.show(showWrapOp({}))(_1.values[0]) + "(" + _ps.Prelude.show(showInquire(__dict_Show_30)(__dict_Show_31))(_1.values[1]) + ")";
                    };
                    throw "Failed pattern match";
                };
            };
        ...
        module.gt = gt;
        var gen = function (__dict_Show_34) {
            return function (__dict_Show_35) {
                return function (_1) {
                    return _ps.Prelude.show(showInquire(__dict_Show_34)(__dict_Show_35))(_1);
                    throw "Failed pattern match";
                };
            };
        };
        ...
        var eqInquire_$eq$eq = function (__dict_Eq_36) {
            return function (__dict_Eq_37) {
                return function (_1) {
                    return function (_2) {
                        ...
                        if (_1.ctor === "Inquire.Pred") {
                            if (_2.ctor === "Inquire.Pred") {
                                return _ps.Prelude["=="](__dict_Eq_36)(_1.values[0])(_2.values[0]) && _ps.Prelude["=="](eqRel({}))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](__dict_Eq_37)(_1.values[2])(_2.values[2]);
                            };
                        };
                        if (_1.ctor === "Inquire.Junc") {
                            if (_2.ctor === "Inquire.Junc") {
                                return _ps.Prelude["=="](eqInquire(__dict_Eq_36)(__dict_Eq_37))(_1.values[0])(_2.values[0]) && _ps.Prelude["=="](eqJuncOp({}))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](eqInquire(__dict_Eq_36)(__dict_Eq_37))(_1.values[2])(_2.values[2]);
                            };
                        };
                        if (_1.ctor === "Inquire.Wrap") {
                            if (_2.ctor === "Inquire.Wrap") {
                                return _ps.Prelude["=="](eqInquire(__dict_Eq_36)(__dict_Eq_37))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](eqWrapOp({}))(_1.values[0])(_2.values[0]);
                            };
                        };
                        return false;
                        throw "Failed pattern match";
        ...
        var eqInquire_$div$eq = function (__dict_Eq_38) {
            return function (__dict_Eq_39) {
                return function (_1) {
                    return function (_2) {
                        return !_ps.Prelude["=="](eqInquire(__dict_Eq_38)(__dict_Eq_39))(_1)(_2);
                        throw "Failed pattern match";
                    };
                };
            };
        ...
        var idempotent = function (__dict_Eq_32) {
            return function (__dict_Eq_33) {
                return function (_1) {
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[1]).ctor === "Inquire.AND") {
                            if (_ps.Prelude["=="](eqInquire(__dict_Eq_32)(__dict_Eq_33))(_1.values[0])(_1.values[2])) {
                                return _1.values[0];
                            };
                        };
                    };
    ...
    _ps.Inquire_Combinators = (function (module) {
        function unsafeFind(v) {  return function(i) {    /* We use String's eq typeclass because it uses `unsafeRefEq`*/    return findI(_ps.Prelude.eqString({}))(v)(i);  }};
        ...
        module.vals = vals;
        var remove$prime = function (__dict_Eq_42) {
                        ...
                        return function (_3) {
                            return (function (_4, _5, _6) {
                                if (_6.ctor === "Inquire.Junc") {
                                    return (function (_1) {
                                        return _4(_6.values[2])(_1) ? _ps.Inquire.Junc(remove$prime(__dict_Eq_42)(__dict_Eq_43)(_4)(_5)(_6.values[0]))(_6.values[1])(_6.values[2]) : _ps.Inquire.Junc(_6.values[0])(_6.values[1])(_1);
                                        throw "Failed pattern match";
                                    })(remove$prime(__dict_Eq_42)(__dict_Eq_43)(_4)(_5)(_6.values[2]));
                                };
                                if (_6.ctor === "Inquire.Wrap") {
                                    return _ps.Inquire.Wrap(_6.values[0])(remove$prime(__dict_Eq_42)(__dict_Eq_43)(_4)(_5)(_6.values[1]));
                                };
                                if (_ps.Prelude["=="](_ps.Inquire.eqInquire(__dict_Eq_42)(__dict_Eq_43))(_5)(_6)) {
        ...
        var removeAll = function (__dict_Eq_44) {
            return function (__dict_Eq_45) {
                return remove$prime(__dict_Eq_44)(__dict_Eq_45)(function (x) {
                    return function (y) {
                        return true;
                    };
                });
        ...
        var remove = function (__dict_Eq_46) {
            return function (__dict_Eq_47) {
                return remove$prime(__dict_Eq_46)(__dict_Eq_47)(_ps.Prelude["=="](_ps.Inquire.eqInquire(__dict_Eq_46)(__dict_Eq_47)));
            };
        };
        ...
        var fromArray = function (_1) {
            ...
            return (function (_2) {
                ...
                if (_2.length > 0) {
                    var _4 = _2.slice(1);
                    if ((_2[0]).length === 2) {
                        return _ps.Inquire.and(fromArray(_4))(_ps.Inquire.eq(_2[0][0])(_2[0][1]));
                    };
                };
                throw "Failed pattern match";
            })(_1);
        ...
        var findI = function (__dict_Eq_48) {
            return function (_1) {
                return function (_2) {
                    if (_2.ctor === "Inquire.Pred") {
                        if (_ps.Prelude["=="](__dict_Eq_48)(_1)(_2.values[2])) {
                    ...
                    if (_2.ctor === "Inquire.Junc") {
                        return _ps.Data_Maybe.maybe(findI(__dict_Eq_48)(_1)(_2.values[0]))(_ps.Data_Maybe.Just)(findI(__dict_Eq_48)(_1)(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Wrap") {
                        return findI(__dict_Eq_48)(_1)(_2.values[1]);
                    };
                    return _ps.Data_Maybe.Nothing;
                    throw "Failed pattern match";
                };
    ...
    _ps.Inquire_Zipper = (function (module) {
        ...
        var zipUp = function (_1) {
            if ((_1.values[0]).path.length > 0) {
                var _7 = (_1.values[0]).path.slice(1);
                if (((_1.values[0]).path[0]).ctor === "Inquire.Zipper.D") {
                    return _ps.Data_Maybe.Just(Zip({
                        hole: _ps.Inquire.Wrap(((_1.values[0]).path[0]).values[0])((_1.values[0]).hole), 
                        path: _7
                    }));
                };
            };
            if ((_1.values[0]).path.length > 0) {
                var _13 = (_1.values[0]).path.slice(1);
                if (((_1.values[0]).path[0]).ctor === "Inquire.Zipper.L") {
                    return _ps.Data_Maybe.Just(Zip({
                        hole: _ps.Inquire.Junc((_1.values[0]).hole)(((_1.values[0]).path[0]).values[0])(((_1.values[0]).path[0]).values[1]), 
                        path: _13
                    }));
                };
            };
            if ((_1.values[0]).path.length > 0) {
                var _20 = (_1.values[0]).path.slice(1);
                if (((_1.values[0]).path[0]).ctor === "Inquire.Zipper.R") {
                    return _ps.Data_Maybe.Just(Zip({
                        hole: _ps.Inquire.Junc(((_1.values[0]).path[0]).values[1])(((_1.values[0]).path[0]).values[0])((_1.values[0]).hole), 
                        path: _20
                    }));
                };
            };
        ...
        var zipRight = function (_1) {
            if ((_1.values[0]).hole.ctor === "Inquire.Junc") {
                return _ps.Data_Maybe.Just(Zip({
                    ...
                    path: _ps.Data_Array[":"](R((_1.values[0]).hole.values[1])((_1.values[0]).hole.values[0]))((_1.values[0]).path)
                }));
            };
            return _ps.Data_Maybe.Nothing;
            throw "Failed pattern match";
        ...
        var zipLeft = function (_1) {
            if ((_1.values[0]).hole.ctor === "Inquire.Junc") {
                return _ps.Data_Maybe.Just(Zip({
                    ...
                    path: _ps.Data_Array[":"](L((_1.values[0]).hole.values[1])((_1.values[0]).hole.values[2]))((_1.values[0]).path)
                }));
            };
            return _ps.Data_Maybe.Nothing;
            throw "Failed pattern match";
        ...
        var zipDown = function (_1) {
            if ((_1.values[0]).hole.ctor === "Inquire.Wrap") {
                return _ps.Data_Maybe.Just(Zip({
                    ...
                    path: _ps.Data_Array[":"](D((_1.values[0]).hole.values[0]))((_1.values[0]).path)
                }));
            };
            if ((_1.values[0]).hole.ctor === "Inquire.Junc") {
                return zipRight(_1);
