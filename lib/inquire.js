(function (_ps) {
    "use strict";
    _ps.Text_Parsing_Read = (function () {
        var module = {};
        function read(dict) {
            return dict.read;
        };
    ...
    _ps.Data_BiTraversable = (function () {
        ...
        var bisequence = function (__dict_Applicative_19) {
            return function (__dict_BiTraversable_20) {
                return function (t) {
                    return bitraverse(__dict_BiTraversable_20)(__dict_Applicative_19)(_ps.Prelude.id(_ps.Prelude.categoryArr({})))(_ps.Prelude.id(_ps.Prelude.categoryArr({})))(t);
                };
            };
        };
    ...
    _ps.Data_BiFunctor = (function () {
        ...
        var second = function (__dict_BiFunctor_21) {
            return function (f) {
                if (typeof f !== "function") {
                    throw "function expected";
                };
                return $less$dollar$dollar$greater(__dict_BiFunctor_21)(_ps.Prelude.id(_ps.Prelude.categoryArr({})))(f);
            };
        };
        var first = function (__dict_BiFunctor_22) {
            return function (f) {
                if (typeof f !== "function") {
                    throw "function expected";
                };
                return $less$dollar$dollar$greater(__dict_BiFunctor_22)(f)(_ps.Prelude.id(_ps.Prelude.categoryArr({})));
            };
        };
        var bimap = function (__dict_BiFunctor_23) {
            return $less$dollar$dollar$greater(__dict_BiFunctor_23);
        };
        ...
        var concatMap = function (_1) {
            ...
            return function (_2) {
                ...
                return (function (_3, _4) {
                    ...
                    if (_4.length > 0) {
                        var _6 = _4.slice(1);
                        return concat(_3(_4[0]))(concatMap(_3)(_6));
                    };
                    throw "Failed pattern match";
                })(_1, _2);
            };
        ...
        var nubBy = function (_1) {
            ...
            return function (_2) {
                ...
                return (function (_3, _4) {
                    ...
                    if (_4.length > 0) {
                        var _6 = _4.slice(1);
                        return $colon(_4[0])(nubBy(_3)(filter(function (y) {
                            return !_3(_4[0])(y);
                        })(_6)));
                    };
                    throw "Failed pattern match";
    ...
    _ps.Control_Monad_Eff_Error = (function () {
        var module = {};
    ...
    _ps.Debug_Trace = (function () {
        ...
        var print = function (__dict_Show_32) {
            return function (o) {
                return trace(_ps.Prelude.show(__dict_Show_32)(o));
            };
        };
        module.print = print;
        module.trace = trace;
    ...
    _ps.Control_Applicative = (function () {
        var module = {};
        var lift3 = function (__dict_Applicative_33) {
            return function (f) {
                if (typeof f !== "function") {
                    throw "function expected";
                };
                return function (x) {
                    return function (y) {
                        return function (z) {
                            return _ps.Prelude["<*>"](__dict_Applicative_33)(_ps.Prelude["<*>"](__dict_Applicative_33)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_33))(f)(x))(y))(z);
                        };
                    };
                };
            };
        };
        var lift2 = function (__dict_Applicative_34) {
            return function (f) {
                if (typeof f !== "function") {
                    throw "function expected";
                };
                return function (x) {
                    return function (y) {
                        return _ps.Prelude["<*>"](__dict_Applicative_34)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_34))(f)(x))(y);
                    };
                };
            };
        };
        var $less$times = function (__dict_Applicative_35) {
            return function (x) {
                return function (y) {
                    return _ps.Prelude["<*>"](__dict_Applicative_35)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_35))(_ps.Prelude["const"])(x))(y);
                };
            };
        };
        var $times$greater = function (__dict_Applicative_36) {
            return function (x) {
                return function (y) {
                    return _ps.Prelude["<*>"](__dict_Applicative_36)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_36))(_ps.Prelude["const"](_ps.Prelude.id(_ps.Prelude.categoryArr({}))))(x))(y);
                };
            };
        };
        module.lift3 = lift3;
    ...
    _ps.Data_Foldable = (function () {
        ...
        var traverse_ = function (__dict_Applicative_37) {
            return function (__dict_Foldable_38) {
                return function (f) {
                    if (typeof f !== "function") {
                        throw "function expected";
                    };
                    return foldr(__dict_Foldable_38)(_ps.Prelude["<<<"](_ps.Prelude.categoryArr({}))(_ps.Control_Applicative["*>"](__dict_Applicative_37))(f))(_ps.Prelude.pure(__dict_Applicative_37)({}));
                };
            };
        };
        var sum = function (__dict_Foldable_39) {
            return foldl(__dict_Foldable_39)(_ps.Prelude["+"](_ps.Prelude.numNumber({})))(0);
        };
        var sequence_ = function (__dict_Applicative_40) {
            return function (__dict_Foldable_41) {
                return traverse_(__dict_Applicative_40)(__dict_Foldable_41)(_ps.Prelude.id(_ps.Prelude.categoryArr({})));
            };
        };
        var product = function (__dict_Foldable_42) {
            return foldl(__dict_Foldable_42)(_ps.Prelude["*"](_ps.Prelude.numNumber({})))(1);
        };
        var or = function (__dict_Foldable_43) {
            return foldl(__dict_Foldable_43)(_ps.Prelude["||"](_ps.Prelude.boolLikeBoolean({})))(false);
        };
        var mconcat = function (__dict_Foldable_44) {
            return function (__dict_Monoid_45) {
                return foldl(__dict_Foldable_44)(_ps.Data_Monoid["<>"](__dict_Monoid_45))(_ps.Data_Monoid.mempty(__dict_Monoid_45));
            };
        };
        var for_ = function (__dict_Applicative_46) {
            return function (__dict_Foldable_47) {
                return _ps.Prelude.flip(traverse_(__dict_Applicative_46)(__dict_Foldable_47));
            };
        };
        ...
        var foldableTuple_foldMap = function (__dict_Monoid_48) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
        ...
        var foldableTuple = function (_1) {
            ...
            return {
                ...
                foldMap: function (__dict_Monoid_49) {
                    return foldableTuple_foldMap(__dict_Monoid_49);
                }
            };
        };
        ...
        var foldableRef_foldMap = function (__dict_Monoid_50) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
        ...
        var foldableRef = function (_1) {
            ...
            return {
                ...
                foldMap: function (__dict_Monoid_51) {
                    return foldableRef_foldMap(__dict_Monoid_51);
                }
            };
        };
        ...
        var foldableMaybe_foldMap = function (__dict_Monoid_52) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    if (_2.ctor === "Data.Maybe.Nothing") {
                        return _ps.Data_Monoid.mempty(__dict_Monoid_52);
                    };
                    if (_2.ctor === "Data.Maybe.Just") {
                        return _1(_2.values[0]);
                    };
        ...
        var foldableMaybe = function (_1) {
            ...
            return {
                ...
                foldMap: function (__dict_Monoid_53) {
                    return foldableMaybe_foldMap(__dict_Monoid_53);
                }
            };
        };
        ...
        var foldableEither_foldMap = function (__dict_Monoid_54) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    if (_2.ctor === "Data.Either.Left") {
                        return _ps.Data_Monoid.mempty(__dict_Monoid_54);
                    };
                    if (_2.ctor === "Data.Either.Right") {
                        return _1(_2.values[0]);
                    };
        ...
        var foldableEither = function (_1) {
            ...
            return {
                ...
                foldMap: function (__dict_Monoid_55) {
                    return foldableEither_foldMap(__dict_Monoid_55);
                }
            };
        };
        var foldableArray = function (_1) {
            ...
            return {
                ...
                foldMap: function (__dict_Monoid_57) {
                    return foldableArray_foldMap(__dict_Monoid_57);
                }
            };
        };
        ...
        var foldableArray_foldMap = function (__dict_Monoid_56) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return (function (_3, _4) {
                        if (_4.length === 0) {
                            return _ps.Data_Monoid.mempty(__dict_Monoid_56);
                        };
                        if (_4.length > 0) {
                            var _6 = _4.slice(1);
                            return _ps.Data_Monoid["<>"](__dict_Monoid_56)(_3(_4[0]))(foldMap(foldableArray({}))(__dict_Monoid_56)(_3)(_6));
                        };
                        throw "Failed pattern match";
                    })(_1, _2);
                };
        ...
        var fold = function (__dict_Foldable_58) {
            return function (__dict_Monoid_59) {
                return foldMap(__dict_Foldable_58)(__dict_Monoid_59)(_ps.Prelude.id(_ps.Prelude.categoryArr({})));
            };
        };
        var find = function (__dict_Foldable_60) {
            return function (p) {
                ...
                return function (f) {
                    return (function (_1) {
                        ...
                        throw "Failed pattern match";
                    })(foldMap(__dict_Foldable_60)(_ps.Data_Monoid.monoidArray({}))(function (x) {
                        return p(x) ? [ x ] : [  ];
                    })(f));
                };
            };
        };
        var any = function (__dict_Foldable_61) {
            return function (p) {
                if (typeof p !== "function") {
                    throw "function expected";
                };
                return _ps.Prelude["<<<"](_ps.Prelude.categoryArr({}))(or(foldableArray({})))(foldMap(__dict_Foldable_61)(_ps.Data_Monoid.monoidArray({}))(function (x) {
                    return [ p(x) ];
                }));
            };
        };
        var elem = function (__dict_Eq_62) {
            return function (__dict_Foldable_63) {
                return _ps.Prelude["<<<"](_ps.Prelude.categoryArr({}))(any(__dict_Foldable_63))(_ps.Prelude["=="](__dict_Eq_62));
            };
        };
        var notElem = function (__dict_Eq_64) {
            return function (__dict_Foldable_65) {
                return function (x) {
                    return _ps.Prelude["<<<"](_ps.Prelude.categoryArr({}))(_ps.Prelude.not(_ps.Prelude.boolLikeBoolean({})))(elem(__dict_Eq_64)(__dict_Foldable_65)(x));
                };
            };
        };
        var and = function (__dict_Foldable_66) {
            return foldl(__dict_Foldable_66)(_ps.Prelude["&&"](_ps.Prelude.boolLikeBoolean({})))(true);
        };
        var all = function (__dict_Foldable_67) {
            return function (p) {
                if (typeof p !== "function") {
                    throw "function expected";
                };
                return _ps.Prelude["<<<"](_ps.Prelude.categoryArr({}))(and(foldableArray({})))(foldMap(__dict_Foldable_67)(_ps.Data_Monoid.monoidArray({}))(function (x) {
                    return [ p(x) ];
                }));
            };
        };
    ...
    _ps.Data_Traversable = (function () {
        ...
        var traversableTuple_traverse = function (__dict_Applicative_68) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_68))(_ps.Data_Tuple.Tuple(_2.values[0]))(_1(_2.values[1]));
                    throw "Failed pattern match";
                };
            };
        };
        var traversableTuple_sequence = function (__dict_Applicative_69) {
            return function (_1) {
                return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_69))(_ps.Data_Tuple.Tuple(_1.values[0]))(_1.values[1]);
                throw "Failed pattern match";
            };
        };
        var traversableTuple = function (_1) {
            ...
            return {
                traverse: function (__dict_Applicative_70) {
                    return traversableTuple_traverse(__dict_Applicative_70);
                }, 
                sequence: function (__dict_Applicative_71) {
                    return traversableTuple_sequence(__dict_Applicative_71);
                }
            };
        };
        var traversableRef_traverse = function (__dict_Applicative_72) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_72))(_ps.Data_Eq.Ref)(_1(_2.values[0]));
                    throw "Failed pattern match";
                };
            };
        };
        var traversableRef_sequence = function (__dict_Applicative_73) {
            return function (_1) {
                return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_73))(_ps.Data_Eq.Ref)(_1.values[0]);
                throw "Failed pattern match";
            };
        };
        var traversableRef = function (_1) {
            ...
            return {
                traverse: function (__dict_Applicative_74) {
                    return traversableRef_traverse(__dict_Applicative_74);
                }, 
                sequence: function (__dict_Applicative_75) {
                    return traversableRef_sequence(__dict_Applicative_75);
                }
            };
        };
        var traversableMaybe_traverse = function (__dict_Applicative_76) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    if (_2.ctor === "Data.Maybe.Nothing") {
                        return _ps.Prelude.pure(__dict_Applicative_76)(_ps.Data_Maybe.Nothing);
                    };
                    if (_2.ctor === "Data.Maybe.Just") {
                        return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_76))(_ps.Data_Maybe.Just)(_1(_2.values[0]));
                    };
                    throw "Failed pattern match";
                };
            };
        };
        var traversableMaybe_sequence = function (__dict_Applicative_77) {
            return function (_1) {
                if (_1.ctor === "Data.Maybe.Nothing") {
                    return _ps.Prelude.pure(__dict_Applicative_77)(_ps.Data_Maybe.Nothing);
                };
                if (_1.ctor === "Data.Maybe.Just") {
                    return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_77))(_ps.Data_Maybe.Just)(_1.values[0]);
                };
                throw "Failed pattern match";
            };
        };
        var traversableMaybe = function (_1) {
            ...
            return {
                traverse: function (__dict_Applicative_78) {
                    return traversableMaybe_traverse(__dict_Applicative_78);
                }, 
                sequence: function (__dict_Applicative_79) {
                    return traversableMaybe_sequence(__dict_Applicative_79);
                }
            };
        };
        var traversableEither_traverse = function (__dict_Applicative_80) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    if (_2.ctor === "Data.Either.Left") {
                        return _ps.Prelude.pure(__dict_Applicative_80)(_ps.Data_Either.Left(_2.values[0]));
                    };
                    if (_2.ctor === "Data.Either.Right") {
                        return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_80))(_ps.Data_Either.Right)(_1(_2.values[0]));
                    };
                    throw "Failed pattern match";
                };
            };
        };
        var traversableEither_sequence = function (__dict_Applicative_81) {
            return function (_1) {
                if (_1.ctor === "Data.Either.Left") {
                    return _ps.Prelude.pure(__dict_Applicative_81)(_ps.Data_Either.Left(_1.values[0]));
                };
                if (_1.ctor === "Data.Either.Right") {
                    return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_81))(_ps.Data_Either.Right)(_1.values[0]);
                };
                throw "Failed pattern match";
            };
        };
        var traversableEither = function (_1) {
            ...
            return {
                traverse: function (__dict_Applicative_82) {
                    return traversableEither_traverse(__dict_Applicative_82);
                }, 
                sequence: function (__dict_Applicative_83) {
                    return traversableEither_sequence(__dict_Applicative_83);
                }
            };
        };
        var traversableArray = function (_1) {
            ...
            return {
                traverse: function (__dict_Applicative_86) {
                    return traversableArray_traverse(__dict_Applicative_86);
                }, 
                sequence: function (__dict_Applicative_87) {
                    return traversableArray_sequence(__dict_Applicative_87);
                }
            };
        };
        var traversableArray_traverse = function (__dict_Applicative_84) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return (function (_3, _4) {
                        if (_4.length === 0) {
                            return _ps.Prelude.pure(__dict_Applicative_84)([  ]);
                        };
                        if (_4.length > 0) {
                            var _6 = _4.slice(1);
                            return _ps.Prelude["<*>"](__dict_Applicative_84)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_84))(_ps.Data_Array[":"])(_3(_4[0])))(traverse(traversableArray({}))(__dict_Applicative_84)(_3)(_6));
                        };
                        throw "Failed pattern match";
                    })(_1, _2);
                };
        ...
        var traversableArray_sequence = function (__dict_Applicative_85) {
            return function (_1) {
                if (!Array.isArray(_1)) {
                    throw "Array expected";
                };
                return (function (_2) {
                    if (_2.length === 0) {
                        return _ps.Prelude.pure(__dict_Applicative_85)([  ]);
                    };
                    if (_2.length > 0) {
                        var _4 = _2.slice(1);
                        return _ps.Prelude["<*>"](__dict_Applicative_85)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_85))(_ps.Data_Array[":"])(_2[0]))(sequence(traversableArray({}))(__dict_Applicative_85)(_4));
                    };
                    throw "Failed pattern match";
                })(_1);
            };
        };
        var $$for = function (__dict_Applicative_88) {
            return function (__dict_Traversable_89) {
                return function (x) {
                    return function (f) {
                        if (typeof f !== "function") {
                            throw "function expected";
                        };
                        return traverse(__dict_Traversable_89)(__dict_Applicative_88)(f)(x);
                    };
                };
            };
        };
    ...
    _ps.Control_Monad = (function () {
        var module = {};
        var zipWithA = function (__dict_Applicative_90) {
            return function (f) {
                if (typeof f !== "function") {
                    throw "function expected";
                };
                return function (xs) {
                    ...
                    return function (ys) {
                        ...
                        return _ps.Data_Traversable.sequence(_ps.Data_Traversable.traversableArray({}))(__dict_Applicative_90)(_ps.Data_Array.zipWith(f)(xs)(ys));
                    };
                };
            };
        };
        var when = function (__dict_Monad_91) {
            return function (_1) {
                if (typeof _1 !== "boolean") {
                    throw "boolean expected";
                };
                return function (_2) {
                    ...
                    if (!_1) {
                        return _ps.Prelude["return"](__dict_Monad_91)({});
                    };
                    throw "Failed pattern match";
                };
            };
        };
        var replicateM = function (__dict_Monad_92) {
            return function (_1) {
                if (typeof _1 !== "number") {
                    throw "number expected";
                };
                return function (_2) {
                    if (_1 === 0) {
                        return _ps.Prelude["return"](__dict_Monad_92)([  ]);
                    };
                    return _ps.Prelude[">>="](__dict_Monad_92)(_2)(function (a) {
                        return _ps.Prelude[">>="](__dict_Monad_92)(replicateM(__dict_Monad_92)(_1 - 1)(_2))(function (as) {
                            if (!Array.isArray(as)) {
                                throw "Array expected";
                            };
                            return _ps.Prelude["return"](__dict_Monad_92)(_ps.Data_Array[":"](a)(as));
                        });
                    });
                    throw "Failed pattern match";
                };
        ...
        var join = function (__dict_Monad_93) {
            return function (mm) {
                return _ps.Prelude[">>="](__dict_Monad_93)(mm)(function (m) {
                    return m;
                });
            };
        };
        var foldM = function (__dict_Monad_94) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    return function (_3) {
                        ...
                        return (function (_4, _5, _6) {
                            if (_6.length === 0) {
                                return _ps.Prelude["return"](__dict_Monad_94)(_5);
                            };
                            if (_6.length > 0) {
                                var _8 = _6.slice(1);
                                return _ps.Prelude[">>="](__dict_Monad_94)(_4(_5)(_6[0]))(function (a$prime) {
                                    return foldM(__dict_Monad_94)(_4)(a$prime)(_8);
                                });
                            };
                            throw "Failed pattern match";
                        })(_1, _2, _3);
        ...
        var $greater$eq$greater = function (__dict_Monad_95) {
            return function (f) {
                if (typeof f !== "function") {
                    throw "function expected";
                };
                return function (g) {
                    ...
                    return function (a) {
                        return _ps.Prelude[">>="](__dict_Monad_95)(f(a))(function (b) {
                            return g(b);
                        });
                    };
                };
        ...
        var $less$eq$less = function (__dict_Monad_96) {
            return _ps.Prelude.flip($greater$eq$greater(__dict_Monad_96));
        };
    ...
    _ps.Inquire = (function () {
        ...
        function generate(i) {  var showDict = {    show: function(k) {      if ({}.toString.call(k).slice(8, -1) === 'Function') {        return k().toString();      } else {        return k.toString();      }    }  };  return gen(showDict)(showDict)(i);};
        ...
        var traversableInquire = function (_1) {
            ...
            return {
                traverse: function (__dict_Applicative_99) {
                    return traversableInquire_traverse(__dict_Applicative_99);
                }, 
                sequence: function (__dict_Applicative_100) {
                    return traversableInquire_sequence(__dict_Applicative_100);
                }
            };
        };
        var traversableInquire_traverse = function (__dict_Applicative_97) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    if (_2.ctor === "Inquire.EmptyAnd") {
                        return _ps.Prelude.pure(__dict_Applicative_97)(EmptyAnd);
                    };
                    if (_2.ctor === "Inquire.EmptyOr") {
                        return _ps.Prelude.pure(__dict_Applicative_97)(EmptyOr);
                    };
                    if (_2.ctor === "Inquire.Pred") {
                        return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_97))(Pred(_2.values[0])(_2.values[1]))(_1(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Junc") {
                        return _ps.Prelude["<*>"](__dict_Applicative_97)(_ps.Prelude["<*>"](__dict_Applicative_97)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_97))(Junc)(_ps.Data_Traversable.traverse(traversableInquire({}))(__dict_Applicative_97)(_1)(_2.values[0])))(_ps.Prelude.pure(__dict_Applicative_97)(_2.values[1])))(_ps.Data_Traversable.traverse(traversableInquire({}))(__dict_Applicative_97)(_1)(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Wrap") {
                        return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_97))(Wrap(_2.values[0]))(_ps.Data_Traversable.traverse(traversableInquire({}))(__dict_Applicative_97)(_1)(_2.values[1]));
                    };
                    throw "Failed pattern match";
                };
            };
        };
        var traversableInquire_sequence = function (__dict_Applicative_98) {
            return _ps.Data_Traversable.traverse(traversableInquire({}))(__dict_Applicative_98)(_ps.Prelude.id(_ps.Prelude.categoryArr({})));
        };
        ...
        var foldableInquire = function (_1) {
            ...
            return {
                ...
                foldMap: function (__dict_Monoid_108) {
                    return foldableInquire_foldMap(__dict_Monoid_108);
                }
            };
        };
        ...
        var foldableInquire_foldMap = function (__dict_Monoid_107) {
            return function (f) {
                if (typeof f !== "function") {
                    throw "function expected";
                };
                return function (x) {
                    return _ps.Data_Foldable.foldr(foldableInquire({}))(_ps.Prelude["<<<"](_ps.Prelude.categoryArr({}))(_ps.Data_Monoid["<>"](__dict_Monoid_107))(f))(_ps.Data_Monoid.mempty(__dict_Monoid_107))(x);
                };
            };
        };
        ...
        var eqRel_$eq$eq = function (_1) {
            return function (_2) {
                if (_1.ctor === "Inquire.IEQ") {
                    if (_2.ctor === "Inquire.IEQ") {
                        return true;
                    };
                };
                if (_1.ctor === "Inquire.INE") {
                    if (_2.ctor === "Inquire.INE") {
                        return true;
                    };
                };
                if (_1.ctor === "Inquire.IGT") {
                    if (_2.ctor === "Inquire.IGT") {
                        return true;
                    };
                };
                if (_1.ctor === "Inquire.IGE") {
                    if (_2.ctor === "Inquire.IGE") {
                        return true;
                    };
                };
                if (_1.ctor === "Inquire.ILT") {
                    if (_2.ctor === "Inquire.ILT") {
                        return true;
                    };
                };
                if (_1.ctor === "Inquire.ILE") {
                    if (_2.ctor === "Inquire.ILE") {
                        return true;
                    };
                };
                return false;
        ...
        var showInquire_show = function (__dict_Show_101) {
            return function (__dict_Show_102) {
                return function (_1) {
                    ...
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[0]).ctor === "Inquire.EmptyAnd") {
                            if ((_1.values[2]).ctor === "Inquire.EmptyAnd") {
                                return "";
                            };
                        };
                    };
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[0]).ctor === "Inquire.EmptyAnd") {
                            if ((_1.values[2]).ctor === "Inquire.EmptyOr") {
                                return "";
                            };
                        };
                    };
                    ...
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[0]).ctor === "Inquire.EmptyOr") {
                            if ((_1.values[2]).ctor === "Inquire.EmptyOr") {
                                return "";
                            };
                        };
                    ...
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[2]).ctor === "Inquire.EmptyOr") {
                            return _ps.Prelude.show(showInquire(__dict_Show_101)(__dict_Show_102))(_1.values[0]);
                        };
                    };
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[2]).ctor === "Inquire.EmptyAnd") {
                    ...
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[0]).ctor === "Inquire.EmptyAnd") {
                            return _ps.Prelude.show(showInquire(__dict_Show_101)(__dict_Show_102))(_1.values[2]);
                        };
                    };
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[0]).ctor === "Inquire.EmptyOr") {
                    ...
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[0]).ctor === "Inquire.Pred") {
                            if ((_1.values[2]).ctor === "Inquire.Pred") {
                                return _ps.Prelude.show(showInquire(__dict_Show_101)(__dict_Show_102))(_1.values[0]) + _ps.Prelude.show(showJuncOp({}))(_1.values[1]) + _ps.Prelude.show(showInquire(__dict_Show_101)(__dict_Show_102))(_1.values[2]);
                            };
                        };
                    };
                    if (_1.ctor === "Inquire.Junc") {
                        ...
                        if ((_1.values[0]).ctor === "Inquire.Junc") {
                            if ((_1.values[2]).ctor === "Inquire.Pred") {
                                if (_ps.Prelude["=="](eqJuncOp({}))((_1.values[0]).values[1])(_1.values[1])) {
                                    return _ps.Prelude.show(showInquire(__dict_Show_101)(__dict_Show_102))(_1.values[0]) + _ps.Prelude.show(showJuncOp({}))((_1.values[0]).values[1]) + _ps.Prelude.show(showInquire(__dict_Show_101)(__dict_Show_102))(_1.values[2]);
                                };
                            };
                        };
                    };
                    ...
                    if (_1.ctor === "Inquire.Wrap") {
                        if ((_1.values[0]).ctor === "Inquire.NOBOOL") {
                            if ((_1.values[1]).ctor === "Inquire.Wrap") {
                                return _ps.Prelude.show(showInquire(__dict_Show_101)(__dict_Show_102))(_1.values[1]);
                            };
                        };
                    };
                    if (_1.ctor === "Inquire.Wrap") {
                    ...
                    if (_1.ctor === "Inquire.Wrap") {
                        return _ps.Prelude.show(showWrapOp({}))(_1.values[0]) + "(" + _ps.Prelude.show(showInquire(__dict_Show_101)(__dict_Show_102))(_1.values[1]) + ")";
                    };
                    throw "Failed pattern match";
                };
            };
        ...
        var gen = function (__dict_Show_105) {
            return function (__dict_Show_106) {
                return function (i) {
                    return _ps.Prelude.show(showInquire(__dict_Show_105)(__dict_Show_106))(i);
                };
            };
        };
        ...
        var eqInquire_$eq$eq = function (__dict_Eq_109) {
            return function (__dict_Eq_110) {
                return function (_1) {
                    return function (_2) {
                        if (_1.ctor === "Inquire.EmptyAnd") {
                            if (_2.ctor === "Inquire.EmptyAnd") {
                        ...
                        if (_1.ctor === "Inquire.Pred") {
                            if (_2.ctor === "Inquire.Pred") {
                                return _ps.Prelude["=="](__dict_Eq_109)(_1.values[0])(_2.values[0]) && _ps.Prelude["=="](eqRel({}))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](__dict_Eq_110)(_1.values[2])(_2.values[2]);
                            };
                        };
                        if (_1.ctor === "Inquire.Junc") {
                            if (_2.ctor === "Inquire.Junc") {
                                return _ps.Prelude["=="](eqInquire(__dict_Eq_109)(__dict_Eq_110))(_1.values[0])(_2.values[0]) && _ps.Prelude["=="](eqJuncOp({}))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](eqInquire(__dict_Eq_109)(__dict_Eq_110))(_1.values[2])(_2.values[2]);
                            };
                        };
                        if (_1.ctor === "Inquire.Wrap") {
                            if (_2.ctor === "Inquire.Wrap") {
                                return _ps.Prelude["=="](eqInquire(__dict_Eq_109)(__dict_Eq_110))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](eqWrapOp({}))(_1.values[0])(_2.values[0]);
                            };
                        };
                        return false;
                        throw "Failed pattern match";
        ...
        var eqInquire_$div$eq = function (__dict_Eq_111) {
            return function (__dict_Eq_112) {
                return function (i) {
                    return function (i$prime) {
                        return !_ps.Prelude["=="](eqInquire(__dict_Eq_111)(__dict_Eq_112))(i)(i$prime);
                    };
                };
            };
        };
        var idempotent = function (__dict_Eq_103) {
            return function (__dict_Eq_104) {
                return function (_1) {
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[1]).ctor === "Inquire.AND") {
                            if (_ps.Prelude["=="](eqInquire(__dict_Eq_103)(__dict_Eq_104))(_1.values[0])(_1.values[2])) {
                                return _1.values[0];
                            };
                        };
                    };
        ...
        var boolLikeInquire_$amp$amp = function (p) {
            return function (q) {
                return Junc(p)(AND)(q);
            };
        };
        ...
        var bitraversableInquire = function (_1) {
            ...
            return {
                bitraverse: function (__dict_Applicative_114) {
                    return bitraversableInquire_bitraverse(__dict_Applicative_114);
                }
            };
        };
        var bitraversableInquire_bitraverse = function (__dict_Applicative_113) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return function (_3) {
                        if (_3.ctor === "Inquire.EmptyAnd") {
                            return _ps.Prelude.pure(__dict_Applicative_113)(EmptyAnd);
                        };
                        if (_3.ctor === "Inquire.EmptyOr") {
                            return _ps.Prelude.pure(__dict_Applicative_113)(EmptyOr);
                        };
                        if (_3.ctor === "Inquire.Pred") {
                            return _ps.Prelude["<*>"](__dict_Applicative_113)(_ps.Prelude["<*>"](__dict_Applicative_113)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_113))(Pred)(_1(_3.values[0])))(_ps.Prelude.pure(__dict_Applicative_113)(_3.values[1])))(_2(_3.values[2]));
                        };
                        if (_3.ctor === "Inquire.Junc") {
                            return _ps.Prelude["<*>"](__dict_Applicative_113)(_ps.Prelude["<*>"](__dict_Applicative_113)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_113))(Junc)(_ps.Data_BiTraversable.bitraverse(bitraversableInquire({}))(__dict_Applicative_113)(_1)(_2)(_3.values[0])))(_ps.Prelude.pure(__dict_Applicative_113)(_3.values[1])))(_ps.Data_BiTraversable.bitraverse(bitraversableInquire({}))(__dict_Applicative_113)(_1)(_2)(_3.values[2]));
                        };
                        if (_3.ctor === "Inquire.Wrap") {
                            return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_113))(Wrap(_3.values[0]))(_ps.Data_BiTraversable.bitraverse(bitraversableInquire({}))(__dict_Applicative_113)(_1)(_2)(_3.values[1]));
                        };
                        throw "Failed pattern match";
                    };
                };
        ...
        var absorb = function (__dict_Eq_115) {
            return function (__dict_Eq_116) {
                return function (_1) {
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[1]).ctor === "Inquire.AND") {
                            if ((_1.values[2]).ctor === "Inquire.Junc") {
                                if (((_1.values[2]).values[1]).ctor === "Inquire.OR") {
                                    if (_ps.Prelude["=="](eqInquire(__dict_Eq_115)(__dict_Eq_116))(_1.values[0])((_1.values[2]).values[0])) {
                                        return _1.values[0];
                                    };
                                };
                            };
    ...
    _ps.Inquire_Combinators = (function () {
        var module = {};
        ...
        var toObj = function (i) {
            return (function (updateVals) {
                ...
                return (function (updateKeys) {
                    ...
                    return _ps.Data_BiFoldable.bifoldr(_ps.Inquire.biFoldableInquire({}))(updateKeys)(updateVals)({
                        keys: [  ], 
                        vals: [  ]
                    })(i);
                })(function (k) {
        ...
        var replaceValByVal = function (__dict_Eq_117) {
            return function (_1) {
                return function (_2) {
                    return function (_3) {
                        if (_3.ctor === "Inquire.Pred") {
                            if (_ps.Prelude["=="](__dict_Eq_117)(_2)(_3.values[2])) {
                                return _ps.Inquire.Pred(_3.values[0])(_3.values[1])(_1);
                            };
                        };
                        if (_3.ctor === "Inquire.Junc") {
                            return _ps.Inquire.Junc(replaceValByVal(__dict_Eq_117)(_1)(_2)(_3.values[0]))(_3.values[1])(replaceValByVal(__dict_Eq_117)(_1)(_2)(_3.values[2]));
                        };
                        if (_3.ctor === "Inquire.Wrap") {
                            return _ps.Inquire.Wrap(_3.values[0])(replaceValByVal(__dict_Eq_117)(_1)(_2)(_3.values[1]));
                        };
                        return _3;
                        throw "Failed pattern match";
                    };
        ...
        var replaceValByKey = function (__dict_Eq_118) {
            return function (_1) {
                return function (_2) {
                    return function (_3) {
                        if (_3.ctor === "Inquire.Pred") {
                            if (_ps.Prelude["=="](__dict_Eq_118)(_2)(_3.values[0])) {
                                return _ps.Inquire.Pred(_2)(_3.values[1])(_1);
                            };
                        };
                        if (_3.ctor === "Inquire.Junc") {
                            return _ps.Inquire.Junc(replaceValByKey(__dict_Eq_118)(_1)(_2)(_3.values[0]))(_3.values[1])(replaceValByKey(__dict_Eq_118)(_1)(_2)(_3.values[2]));
                        };
                        if (_3.ctor === "Inquire.Wrap") {
                            return _ps.Inquire.Wrap(_3.values[0])(replaceValByKey(__dict_Eq_118)(_1)(_2)(_3.values[1]));
                        };
                        return _3;
                        throw "Failed pattern match";
                    };
        ...
        var remove$prime = function (__dict_Eq_119) {
            return function (__dict_Eq_120) {
                return function (_1) {
                    if (typeof _1 !== "function") {
                        throw "function expected";
                    };
                    return function (_2) {
                        return function (_3) {
                            if (_3.ctor === "Inquire.Junc") {
                                return (function (r$prime) {
                                    return _1(_3.values[2])(r$prime) ? _ps.Inquire.Junc(remove$prime(__dict_Eq_119)(__dict_Eq_120)(_1)(_2)(_3.values[0]))(_3.values[1])(_3.values[2]) : _ps.Inquire.Junc(_3.values[0])(_3.values[1])(r$prime);
                                })(remove$prime(__dict_Eq_119)(__dict_Eq_120)(_1)(_2)(_3.values[2]));
                            };
                            if (_3.ctor === "Inquire.Wrap") {
                                return _ps.Inquire.Wrap(_3.values[0])(remove$prime(__dict_Eq_119)(__dict_Eq_120)(_1)(_2)(_3.values[1]));
                            };
                            if (_ps.Prelude["=="](_ps.Inquire.eqInquire(__dict_Eq_119)(__dict_Eq_120))(_2)(_3)) {
        ...
        var removeAll = function (__dict_Eq_121) {
            return function (__dict_Eq_122) {
                return remove$prime(__dict_Eq_121)(__dict_Eq_122)(function (x) {
                    return function (y) {
                        return true;
                    };
                });
        ...
        var remove = function (__dict_Eq_123) {
            return function (__dict_Eq_124) {
                return remove$prime(__dict_Eq_123)(__dict_Eq_124)(_ps.Prelude["=="](_ps.Inquire.eqInquire(__dict_Eq_123)(__dict_Eq_124)));
            };
        };
        var keys = function (i) {
            return (toObj(i)).keys;
        ...
        var fromArrayPair = function (_1) {
            ...
            return (function (_2) {
                ...
                if (_2.length === 1) {
                    if ((_2[0]).length === 2) {
                        return _ps.Inquire.eq(_2[0][0])(_2[0][1]);
                    };
                };
                if (_2.length > 0) {
                    var _7 = _2.slice(1);
                    if ((_2[0]).length === 2) {
                        return _ps.Inquire.and(_ps.Inquire.eq(_2[0][0])(_2[0][1]))(fromArrayPair(_7));
                    };
                };
                throw "Failed pattern match";
            })(_1);
        ...
        var fromArrayObj = function (_1) {
            ...
            return (function (_2) {
                ...
                if (_2.length === 1) {
                    return _ps.Inquire.eq((_2[0]).key)((_2[0]).val);
                };
                if (_2.length > 0) {
                    var _7 = _2.slice(1);
                    return _ps.Inquire.and(_ps.Inquire.eq((_2[0]).key)((_2[0]).val))(fromArrayObj(_7));
                };
                throw "Failed pattern match";
            })(_1);
        };
        var findByVal = function (__dict_Eq_125) {
            return function (_1) {
                return function (_2) {
                    if (_2.ctor === "Inquire.Pred") {
                        if (_ps.Prelude["=="](__dict_Eq_125)(_1)(_2.values[2])) {
                    ...
                    if (_2.ctor === "Inquire.Junc") {
                        return _ps.Data_Maybe.maybe(findByVal(__dict_Eq_125)(_1)(_2.values[0]))(_ps.Data_Maybe.Just)(findByVal(__dict_Eq_125)(_1)(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Wrap") {
                        return findByVal(__dict_Eq_125)(_1)(_2.values[1]);
                    };
                    return _ps.Data_Maybe.Nothing;
                    throw "Failed pattern match";
                };
        ...
        var findByKey = function (__dict_Eq_126) {
            return function (_1) {
                return function (_2) {
                    if (_2.ctor === "Inquire.Pred") {
                        if (_ps.Prelude["=="](__dict_Eq_126)(_1)(_2.values[0])) {
                    ...
                    if (_2.ctor === "Inquire.Junc") {
                        return _ps.Data_Maybe.maybe(findByKey(__dict_Eq_126)(_1)(_2.values[0]))(_ps.Data_Maybe.Just)(findByKey(__dict_Eq_126)(_1)(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Wrap") {
                        return findByKey(__dict_Eq_126)(_1)(_2.values[1]);
                    };
                    return _ps.Data_Maybe.Nothing;
                    throw "Failed pattern match";
                };
