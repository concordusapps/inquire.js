(function (_ps) {
    ...
    _ps.Data_Array = (function (module) {
        ...
        var __Prelude_Show_Prim_Array_show = function (__dict_Show_8) {
            return function (_1) {
                return "[" + joinWith(map(_ps.Prelude.show(__dict_Show_8))(_1))(",") + "]";
                throw "Failed pattern match";
            };
        };
    ...
    _ps.Control_Monad = (function (module) {
        ...
        var sequence = function (__dict_Monad_14) {
            return function (_1) {
                ...
                if (_1.length > 0) {
                    var _4 = _1.slice(1);
                    return _ps.Prelude[">>="](__dict_Monad_14)(_1[0])(function (a) {
        ...
        var mapM = function (__dict_Monad_16) {
            return function (_1) {
                return function (_2) {
                    ...
                    if (_2.length > 0) {
                        var _6 = _2.slice(1);
                        return _ps.Prelude[">>="](__dict_Monad_16)(_1(_2[0]))(function (b) {
                            return _ps.Prelude[">>="](__dict_Monad_16)(mapM(__dict_Monad_16)(_1)(_6))(function (bs) {
        ...
        var foldM = function (__dict_Monad_18) {
            return function (_1) {
                return function (_2) {
                    return function (_3) {
                        if (_3.length === 0) {
                            return _ps.Prelude["return"](__dict_Monad_18)(_2);
                        };
                        if (_3.length > 0) {
                            var _8 = _3.slice(1);
                            return _ps.Prelude[">>="](__dict_Monad_18)(_1(_2)(_3[0]))(function (a$prime) {
                                return foldM(__dict_Monad_18)(_1)(a$prime)(_8);
                            });
                        };
                        throw "Failed pattern match";
                    };
    ...
    _ps.Inquire = (function (module) {
        ...
        var __Algebra_Semigroup_Inquire_Inquire_$bar$plus$bar = function (_1) {
            return function (_2) {
                if (_1.ctor === "Inquire.EmptyAnd") {
                    if (_2.ctor === "Inquire.EmptyAnd") {
                        return EmptyAnd;
                ...
                return Junc(_1)(IAnd)(_2);
                throw "Failed pattern match";
            };
        };
        module.__Algebra_Semigroup_Inquire_Inquire_$bar$plus$bar = __Algebra_Semigroup_Inquire_Inquire_$bar$plus$bar;
        var __Algebra_Semigroup_Inquire_Inquire = function (_1) {
            return {
                $bar$plus$bar: __Algebra_Semigroup_Inquire_Inquire_$bar$plus$bar
            };
        };
        module.__Algebra_Semigroup_Inquire_Inquire = __Algebra_Semigroup_Inquire_Inquire;
        var and = _ps.Algebra["|+|"](__Algebra_Semigroup_Inquire_Inquire({}));
        module.and = and;
        var __Algebra_Monoid_Inquire_Inquire_ident = EmptyAnd;
        module.__Algebra_Monoid_Inquire_Inquire_ident = __Algebra_Monoid_Inquire_Inquire_ident;
        var __Algebra_Monoid_Inquire_Inquire = function (_1) {
            return {
                ident: __Algebra_Monoid_Inquire_Inquire_ident
            };
        };
        module.__Algebra_Monoid_Inquire_Inquire = __Algebra_Monoid_Inquire_Inquire;
        var $less$less$dollar$greater$greater = _ps.Prelude["<$>"](__Prelude_Functor_Inquire_Inquire({}));
        module["<<$>>"] = $less$less$dollar$greater$greater;
        return module;
    })(_ps.Inquire || {});
