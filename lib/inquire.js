(function (_ps) {
    ...
    _ps.Inquire = (function (module) {
        ...
        var __Prelude_Show_Inquire_Inquire_show = function (__dict_Show_25) {
            return function (__dict_Show_26) {
                return function (_1) {
                    ...
                    if (_1.ctor === "Inquire.Pred") {
                        return _ps.Prelude.show(__dict_Show_25)(_1.values[0]) + _ps.Prelude.show(__Prelude_Show_Inquire_Rel({}))(_1.values[1]) + _ps.Prelude.show(__dict_Show_26)(_1.values[2]);
                    };
                    if (_1.ctor === "Inquire.Junc") {
                        return "(" + _ps.Prelude.show(__Prelude_Show_Inquire_Inquire(__dict_Show_25)(__dict_Show_26))(_1.values[0]) + ")" + _ps.Prelude.show(__Prelude_Show_Inquire_JuncOp({}))(_1.values[1]) + "(" + _ps.Prelude.show(__Prelude_Show_Inquire_Inquire(__dict_Show_25)(__dict_Show_26))(_1.values[2]) + ")";
                    };
                    if (_1.ctor === "Inquire.Wrap") {
                        return _ps.Prelude.show(__Prelude_Show_Inquire_WrapOp({}))(_1.values[0]) + "(" + _ps.Prelude.show(__Prelude_Show_Inquire_Inquire(__dict_Show_25)(__dict_Show_26))(_1.values[1]) + ")";
                    };
                    throw "Failed pattern match";
                };
            };
        ...
        var __Prelude_Eq_Inquire_Inquire_$eq$eq = function (__dict_Eq_27) {
            return function (__dict_Eq_28) {
                return function (_1) {
                    return function (_2) {
                        if (_1.ctor === "Inquire.EmptyAnd") {
                            if (_2.ctor === "Inquire.EmptyAnd") {
                        ...
                        if (_1.ctor === "Inquire.Pred") {
                            if (_2.ctor === "Inquire.Pred") {
                                return _ps.Prelude["=="](__dict_Eq_27)(_1.values[0])(_2.values[0]) && _ps.Prelude["=="](__Prelude_Eq_Inquire_Rel({}))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](__dict_Eq_28)(_1.values[2])(_2.values[2]);
                            };
                        };
                        if (_1.ctor === "Inquire.Junc") {
                            if (_2.ctor === "Inquire.Junc") {
                                return _ps.Prelude["=="](__Prelude_Eq_Inquire_Inquire(__dict_Eq_27)(__dict_Eq_28))(_1.values[0])(_2.values[0]) && _ps.Prelude["=="](__Prelude_Eq_Inquire_JuncOp({}))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](__Prelude_Eq_Inquire_Inquire(__dict_Eq_27)(__dict_Eq_28))(_1.values[2])(_2.values[2]);
                            };
                        };
                        if (_1.ctor === "Inquire.Wrap") {
                            if (_2.ctor === "Inquire.Wrap") {
                                return _ps.Prelude["=="](__Prelude_Eq_Inquire_Inquire(__dict_Eq_27)(__dict_Eq_28))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](__Prelude_Eq_Inquire_WrapOp({}))(_1.values[0])(_2.values[0]);
                            };
                        };
                        return false;
                        throw "Failed pattern match";
        ...
        var __Prelude_Eq_Inquire_Inquire_$div$eq = function (__dict_Eq_29) {
            return function (__dict_Eq_30) {
                return function (_1) {
                    return function (_2) {
                        return !_ps.Prelude["=="](__Prelude_Eq_Inquire_Inquire(__dict_Eq_29)(__dict_Eq_30))(_1)(_2);
                        throw "Failed pattern match";
                    };
                };
            };
        ...
        var absorb = function (__dict_Eq_23) {
            return function (__dict_Eq_24) {
                return function (_1) {
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[1]).ctor === "Inquire.And") {
                            if ((_1.values[2]).ctor === "Inquire.Junc") {
                                if (((_1.values[2]).values[1]).ctor === "Inquire.Or") {
                                    if (_ps.Prelude["=="](__Prelude_Eq_Inquire_Inquire(__dict_Eq_23)(__dict_Eq_24))(_1.values[0])((_1.values[2]).values[0])) {
                                        return _1.values[0];
                                    };
                                };
                            };
