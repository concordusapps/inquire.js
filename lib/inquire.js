(function (_ps) {
    ...
    _ps.Prelude = (function (module) {
        ...
        module["++"] = $plus$plus;
        var showString_show = function (_1) {
            if (typeof _1 !== "string") {
        ...
        var readString_read = function (_1) {
            if (typeof _1 !== "string") {
                throw "string expected";
            };
            return (function (_2) {
        ...
        module["const"] = $$const;
        var categoryArr_id = function (_1) {
            return _1;
            throw "Failed pattern match";
        };
        module.categoryArr_id = categoryArr_id;
        var categoryArr_$less$less$less = function (_1) {
            if (typeof _1 !== "function") {
                throw "function expected";
            };
            return function (_2) {
        ...
        var categoryArr_$greater$greater$greater = function (_1) {
            if (typeof _1 !== "function") {
                throw "function expected";
            };
            return function (_2) {
        ...
        var eqArray_$div$eq = function (__dict_Eq_2) {
            return function (_1) {
                ...
                return function (_2) {
                    ...
                    return (function (_3, _4) {
                        return not(boolLikeBoolean({}))($eq$eq(eqArray(__dict_Eq_2))(_3)(_4));
                        throw "Failed pattern match";
                    })(_1, _2);
                };
            };
    ...
    _ps.Data_Maybe = (function (module) {
        ...
        module.maybe = maybe;
        var monadMaybe_$greater$greater$eq = function (_1) {
            return function (_2) {
                if (typeof _2 !== "function") {
                    throw "function expected";
                };
        ...
        var fromMaybe = function (_1) {
            return maybe(_1)(_ps.Prelude.id(_ps.Prelude.categoryArr({})));
            throw "Failed pattern match";
        };
    ...
    _ps.Data_Functor = (function (module) {
        ...
        var second = function (__dict_BiFunctor_6) {
            return function (_1) {
                ...
                return (function (_2) {
                    return $less$dollar$dollar$greater(__dict_BiFunctor_6)(_ps.Prelude.id(_ps.Prelude.categoryArr({})))(_2);
                    throw "Failed pattern match";
                })(_1);
            };
        };
        ...
        var first = function (__dict_BiFunctor_8) {
            return function (_1) {
                ...
                return (function (_2) {
                    return $less$dollar$dollar$greater(__dict_BiFunctor_8)(_2)(_ps.Prelude.id(_ps.Prelude.categoryArr({})));
                    throw "Failed pattern match";
                })(_1);
            };
        };
    ...
    _ps.Data_Array = (function (module) {
        ...
        var showArray_show = function (__dict_Show_12) {
            return function (_1) {
                ...
                return (function (_2) {
                    return "[" + joinWith(map(_ps.Prelude.show(__dict_Show_12))(_2))(",") + "]";
                    throw "Failed pattern match";
                })(_1);
            };
        };
        ...
        var foldMap = function (__dict_Foldable_14) {
            return function (__dict_Monoid_15) {
                return function (_1) {
                    ...
                    return function (_2) {
                        return foldr(__dict_Foldable_14)(_ps.Prelude["<<<"](_ps.Prelude.categoryArr({}))(_ps.Data_Monoid["<>"](__dict_Monoid_15))(_1))(_ps.Data_Monoid.mempty(__dict_Monoid_15))(_2);
                        throw "Failed pattern match";
                    };
                };
            };
    ...
    _ps.Data_Traversable = (function (module) {
        ...
        var sequence = function (__dict_Applicative_16) {
            return function (__dict_Traversable_17) {
                return function (_1) {
                    return traverse(__dict_Traversable_17)(__dict_Applicative_16)(_ps.Prelude.id(_ps.Prelude.categoryArr({})))(_1);
                    throw "Failed pattern match";
                };
            };
        };
        ...
        var bisequence = function (__dict_Applicative_18) {
            return function (__dict_BiTraversable_19) {
                return function (_1) {
                    return bitraverse(__dict_BiTraversable_19)(__dict_Applicative_18)(_ps.Prelude.id(_ps.Prelude.categoryArr({})))(_ps.Prelude.id(_ps.Prelude.categoryArr({})))(_1);
                    throw "Failed pattern match";
                };
            };
        };
    ...
    _ps.Data_Tuple = (function (module) {
        ...
        var showTuple_show = function (__dict_Show_20) {
            return function (__dict_Show_21) {
                return function (_1) {
                    return "Tuple(" + _ps.Prelude.show(__dict_Show_20)(_1.values[0]) + ", " + _ps.Prelude.show(__dict_Show_21)(_1.values[1]) + ")";
                    throw "Failed pattern match";
                };
            };
        };
    ...
    _ps.Debug_Trace = (function (module) {
        ...
        module.trace = trace;
        var print = function (__dict_Show_22) {
            return function (_1) {
                return trace(_ps.Prelude.show(__dict_Show_22)(_1));
                throw "Failed pattern match";
            };
        };
        module.print = print;
    ...
    _ps.Control_Monad = (function (module) {
        var when = function (__dict_Monad_23) {
            return function (_1) {
                if (typeof _1 !== "boolean") {
                    throw "boolean expected";
                };
                return function (_2) {
                    ...
                    if (!_1) {
                        return _ps.Prelude["return"](__dict_Monad_23)({});
                    };
                    throw "Failed pattern match";
                };
            };
        ...
        module.when = when;
        var sequence = function (__dict_Monad_24) {
            return function (_1) {
                if (!Array.isArray(_1)) {
                    throw "Array expected";
                };
                return (function (_2) {
                    if (_2.length === 0) {
                        return _ps.Prelude["return"](__dict_Monad_24)([  ]);
                    };
                    if (_2.length > 0) {
                        var _4 = _2.slice(1);
                        return _ps.Prelude[">>="](__dict_Monad_24)(_2[0])(function (a) {
                            return _ps.Prelude[">>="](__dict_Monad_24)(sequence(__dict_Monad_24)(_4))(function (as) {
                                if (!Array.isArray(as)) {
                                    throw "Array expected";
                                };
                                return _ps.Prelude["return"](__dict_Monad_24)(_ps.Data_Array[":"](a)(as));
                            });
                        });
                    };
                    throw "Failed pattern match";
        ...
        module.sequence = sequence;
        var zipWithM = function (__dict_Monad_25) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return function (_3) {
                        ...
                        return (function (_4, _5, _6) {
                            return sequence(__dict_Monad_25)(_ps.Data_Array.zipWith(_4)(_5)(_6));
                            throw "Failed pattern match";
                        })(_1, _2, _3);
                    };
                };
        ...
        var replicateM = function (__dict_Monad_26) {
            return function (_1) {
                ...
                return function (_2) {
                    if (_1 === 0) {
                        return _ps.Prelude["return"](__dict_Monad_26)([  ]);
                    };
                    return _ps.Prelude[">>="](__dict_Monad_26)(_2)(function (a) {
                        return _ps.Prelude[">>="](__dict_Monad_26)(replicateM(__dict_Monad_26)(_1 - 1)(_2))(function (as) {
                            if (!Array.isArray(as)) {
                                throw "Array expected";
                            };
                            return _ps.Prelude["return"](__dict_Monad_26)(_ps.Data_Array[":"](a)(as));
                        });
                    });
                    throw "Failed pattern match";
                };
        ...
        var mapM = function (__dict_Monad_27) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return (function (_3, _4) {
                        if (_4.length === 0) {
                            return _ps.Prelude["return"](__dict_Monad_27)([  ]);
                        };
                        if (_4.length > 0) {
                            var _6 = _4.slice(1);
                            return _ps.Prelude[">>="](__dict_Monad_27)(_3(_4[0]))(function (b) {
                                return _ps.Prelude[">>="](__dict_Monad_27)(mapM(__dict_Monad_27)(_3)(_6))(function (bs) {
                                    if (!Array.isArray(bs)) {
                                        throw "Array expected";
                                    };
                                    return _ps.Prelude["return"](__dict_Monad_27)(_ps.Data_Array[":"](b)(bs));
                                });
                            });
                        };
                        throw "Failed pattern match";
        ...
        module.mapM = mapM;
        var join = function (__dict_Monad_28) {
            return function (_1) {
                return _ps.Prelude[">>="](__dict_Monad_28)(_1)(function (m) {
                    return m;
                });
                throw "Failed pattern match";
            };
            ...
            return function (_1) {
                ...
                return function (_2) {
                    return function (_3) {
                        ...
                        return (function (_4, _5, _6) {
                            if (_6.length === 0) {
                                return _ps.Prelude["return"](__dict_Monad_29)(_5);
                            };
                            if (_6.length > 0) {
                                var _8 = _6.slice(1);
                                return _ps.Prelude[">>="](__dict_Monad_29)(_4(_5)(_6[0]))(function (a$prime) {
                                    return foldM(__dict_Monad_29)(_4)(a$prime)(_8);
                                });
                            };
                            throw "Failed pattern match";
                        })(_1, _2, _3);
        ...
        module.foldM = foldM;
        var $greater$eq$greater = function (__dict_Monad_30) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return function (_3) {
                        return _ps.Prelude[">>="](__dict_Monad_30)(_1(_3))(function (b) {
                            return _2(b);
                        });
                        throw "Failed pattern match";
                    };
        ...
        var $less$eq$less = function (__dict_Monad_31) {
            return _ps.Prelude.flip($greater$eq$greater(__dict_Monad_31));
        };
        module["<=<"] = $less$eq$less;
        return module;
    })(_ps.Control_Monad || {});
    ...
    _ps.Inquire = (function (module) {
        ...
        function objExtend(oldO) {  function betterTypeof(x) {    return {}.toString.call(x).slice(8, -1);  };  function deepObj(x) {    var obj = {};    Object.getOwnPropertyNames(x).forEach(function(key) {      var val = x[key];      if (betterTypeof(val) === 'Object') {        obj[key] = deepObj(val);      } else if (betterTypeof(val) === 'Array') {        obj[key] = deepArray(val);      } else {        obj[key] = val;      }    });    return obj;  };  function deepArray(x) {    var arr = [];    x.forEach(function(val) {      if (betterTypeof(val) === 'Object') {        arr.push(deepObj(val));      } else if (betterTypeof(val) === 'Array') {        arr.push(deepArray(val));      } else {        arr.push(val);      }    });    return arr;  };  return function(newO) {    var obj0 = deepObj(oldO);    var obj1 = deepObj(newO);    Object.getOwnPropertyNames(obj1).forEach(function(key) {      obj0[key] = obj1[key];    });    return obj0;  }};
        module.objExtend = objExtend;
        var traversableInquire = function (_1) {
            if (typeof _1 !== "object") {
                throw "object expected";
            };
            return {
                traverse: function (__dict_Applicative_33) {
                    return traversableInquire_traverse(__dict_Applicative_33);
                }
            };
        };
        module.traversableInquire = traversableInquire;
        var traversableInquire_traverse = function (__dict_Applicative_32) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    if (_2.ctor === "Inquire.Pred") {
                        return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_32))(Pred(_2.values[0])(_2.values[1]))(_1(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Junc") {
                        return _ps.Prelude["<*>"](__dict_Applicative_32)(_ps.Prelude["<*>"](__dict_Applicative_32)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_32))(Junc)(_ps.Data_Traversable.traverse(traversableInquire({}))(__dict_Applicative_32)(_1)(_2.values[0])))(_ps.Prelude.pure(__dict_Applicative_32)(_2.values[1])))(_ps.Data_Traversable.traverse(traversableInquire({}))(__dict_Applicative_32)(_1)(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Wrap") {
                        return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_32))(Wrap(_2.values[0]))(_ps.Data_Traversable.traverse(traversableInquire({}))(__dict_Applicative_32)(_1)(_2.values[1]));
                    };
                    throw "Failed pattern match";
                };
            };
        ...
        var pred = function (_1) {
            if (typeof _1 !== "object") {
                throw "object expected";
            };
            return (function (_2) {
                return Pred(_2.key)(_2.rel)(_2.val);
                throw "Failed pattern match";
            })(_1);
        };
        module.pred = pred;
        var neObj = function (_1) {
            if (typeof _1 !== "object") {
                throw "object expected";
            };
            return (function (_2) {
        ...
        var foldableInquire_foldl = function (_1) {
            if (typeof _1 !== "function") {
                throw "function expected";
            };
            return function (_2) {
                return function (_3) {
                    return _ps.Data_Foldable.foldr(foldableInquire({}))(_ps.Prelude.flip(_1))(_2)(_3);
                    throw "Failed pattern match";
                };
            };
        };
        ...
        var eqWrapOp_$div$eq = function (_1) {
            return function (_2) {
                return !_ps.Prelude["=="](eqWrapOp({}))(_1)(_2);
                throw "Failed pattern match";
            };
        };
        ...
        module.eqRel = eqRel;
        var eqRel_$div$eq = function (_1) {
            return function (_2) {
                return !_ps.Prelude["=="](eqRel({}))(_1)(_2);
                throw "Failed pattern match";
            };
        };
        module.eqRel_$div$eq = eqRel_$div$eq;
        var eqObj = function (_1) {
            if (typeof _1 !== "object") {
                throw "object expected";
            };
            return (function (_2) {
        ...
        var eqJuncOp_$div$eq = function (_1) {
            return function (_2) {
                return !_ps.Prelude["=="](eqJuncOp({}))(_1)(_2);
                throw "Failed pattern match";
            };
        };
        module.eqJuncOp_$div$eq = eqJuncOp_$div$eq;
        var showInquire_show = function (__dict_Show_34) {
            return function (__dict_Show_35) {
                return function (_1) {
                    if (_1.ctor === "Inquire.EmptyAnd") {
                        return "";
                    };
                    ...
                    if (_1.ctor === "Inquire.Pred") {
                        return _ps.Prelude.show(__dict_Show_34)(_1.values[0]) + _ps.Prelude.show(showRel({}))(_1.values[1]) + _ps.Prelude.show(__dict_Show_35)(_1.values[2]);
                    };
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[0]).ctor === "Inquire.Pred") {
                            if ((_1.values[2]).ctor === "Inquire.Pred") {
                                return _ps.Prelude.show(showInquire(__dict_Show_34)(__dict_Show_35))(_1.values[0]) + _ps.Prelude.show(showJuncOp({}))(_1.values[1]) + _ps.Prelude.show(showInquire(__dict_Show_34)(__dict_Show_35))(_1.values[2]);
                            };
                        };
                    };
                    if (_1.ctor === "Inquire.Junc") {
                        ...
                        if ((_1.values[0]).ctor === "Inquire.Junc") {
                            if ((_1.values[2]).ctor === "Inquire.Junc") {
                                if (_ps.Prelude["=="](eqJuncOp({}))((_1.values[0]).values[1])(_1.values[1]) && _ps.Prelude["=="](eqJuncOp({}))(_1.values[1])((_1.values[2]).values[1])) {
                                    return _ps.Prelude.show(showInquire(__dict_Show_34)(__dict_Show_35))(_1.values[0]) + _ps.Prelude.show(showJuncOp({}))((_1.values[0]).values[1]) + _ps.Prelude.show(showInquire(__dict_Show_34)(__dict_Show_35))(_1.values[2]);
                                };
                            };
                        };
                    };
                    ...
                    if (_1.ctor === "Inquire.Wrap") {
                        if ((_1.values[0]).ctor === "Inquire.NOBOOL") {
                            if ((_1.values[1]).ctor === "Inquire.Wrap") {
                                return _ps.Prelude.show(showInquire(__dict_Show_34)(__dict_Show_35))(_1.values[1]);
                            };
                        };
                    };
                    if (_1.ctor === "Inquire.Wrap") {
                    ...
                    if (_1.ctor === "Inquire.Wrap") {
                        return _ps.Prelude.show(showWrapOp({}))(_1.values[0]) + "(" + _ps.Prelude.show(showInquire(__dict_Show_34)(__dict_Show_35))(_1.values[1]) + ")";
                    };
                    throw "Failed pattern match";
                };
            };
        ...
        var gen = function (__dict_Show_38) {
            return function (__dict_Show_39) {
                return function (_1) {
                    return _ps.Prelude.show(showInquire(__dict_Show_38)(__dict_Show_39))(_1);
                    throw "Failed pattern match";
                };
            };
        };
        ...
        var eqInquire_$eq$eq = function (__dict_Eq_40) {
            return function (__dict_Eq_41) {
                return function (_1) {
                    return function (_2) {
                        ...
                        if (_1.ctor === "Inquire.Pred") {
                            if (_2.ctor === "Inquire.Pred") {
                                return _ps.Prelude["=="](__dict_Eq_40)(_1.values[0])(_2.values[0]) && _ps.Prelude["=="](eqRel({}))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](__dict_Eq_41)(_1.values[2])(_2.values[2]);
                            };
                        };
                        if (_1.ctor === "Inquire.Junc") {
                            if (_2.ctor === "Inquire.Junc") {
                                return _ps.Prelude["=="](eqInquire(__dict_Eq_40)(__dict_Eq_41))(_1.values[0])(_2.values[0]) && _ps.Prelude["=="](eqJuncOp({}))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](eqInquire(__dict_Eq_40)(__dict_Eq_41))(_1.values[2])(_2.values[2]);
                            };
                        };
                        if (_1.ctor === "Inquire.Wrap") {
                            if (_2.ctor === "Inquire.Wrap") {
                                return _ps.Prelude["=="](eqInquire(__dict_Eq_40)(__dict_Eq_41))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](eqWrapOp({}))(_1.values[0])(_2.values[0]);
                            };
                        };
                        return false;
                        throw "Failed pattern match";
        ...
        var eqInquire_$div$eq = function (__dict_Eq_42) {
            return function (__dict_Eq_43) {
                return function (_1) {
                    return function (_2) {
                        return !_ps.Prelude["=="](eqInquire(__dict_Eq_42)(__dict_Eq_43))(_1)(_2);
                        throw "Failed pattern match";
                    };
                };
            };
        ...
        var idempotent = function (__dict_Eq_36) {
            return function (__dict_Eq_37) {
                return function (_1) {
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[1]).ctor === "Inquire.AND") {
                            if (_ps.Prelude["=="](eqInquire(__dict_Eq_36)(__dict_Eq_37))(_1.values[0])(_1.values[2])) {
                                return _1.values[0];
                            };
                        };
                    };
        ...
        module.eq = eq;
        var complementedLatticeInquire_$bar$tilde$bar = function (_1) {
            if (_1.ctor === "Inquire.EmptyAnd") {
                return EmptyOr;
            };
            if (_1.ctor === "Inquire.EmptyOr") {
        ...
        module.complementedLatticeInquire_$bar$tilde$bar = complementedLatticeInquire_$bar$tilde$bar;
        var complementedLatticeInquire = function (_1) {
            if (typeof _1 !== "object") {
                throw "object expected";
            };
            return {
                $bar$tilde$bar: complementedLatticeInquire_$bar$tilde$bar
            };
        };
        module.complementedLatticeInquire = complementedLatticeInquire;
        var neg = function (_1) {
            return _ps.Algebra["|~|"](complementedLatticeInquire({}))(_1);
            throw "Failed pattern match";
        };
        module.neg = neg;
        var booleanAlgebraInquire_$bar$bar$bar = function (_1) {
            return function (_2) {
                if (_1.ctor === "Inquire.EmptyAnd") {
                    return EmptyAnd;
                };
        ...
        module.booleanAlgebraInquire_$bar$bar$bar = booleanAlgebraInquire_$bar$bar$bar;
        var booleanAlgebraInquire_$bar$amp$bar = function (_1) {
            return function (_2) {
                if (_1.ctor === "Inquire.EmptyOr") {
                    return EmptyOr;
                };
        ...
        module.booleanAlgebraInquire_$bar$amp$bar = booleanAlgebraInquire_$bar$amp$bar;
        var booleanAlgebraInquire = function (_1) {
            if (typeof _1 !== "object") {
                throw "object expected";
            };
            return {
                $bar$bar$bar: booleanAlgebraInquire_$bar$bar$bar, 
                $bar$amp$bar: booleanAlgebraInquire_$bar$amp$bar
            };
        };
        module.booleanAlgebraInquire = booleanAlgebraInquire;
                        ...
                        if ((_1.values[1]).ctor === "Inquire.AND") {
                            if ((_1.values[2]).ctor === "Inquire.Junc") {
                                if (((_1.values[2]).values[1]).ctor === "Inquire.OR") {
                                    return _ps.Algebra["|&|"](booleanAlgebraInquire({}))((_1.values[2]).values[0])(_ps.Algebra["|||"](booleanAlgebraInquire({}))((_1.values[0]).values[2])((_1.values[2]).values[2]));
                                };
                            };
                        };
                    };
        ...
        var commute = function (_1) {
            if (_1.ctor === "Inquire.Junc") {
                if ((_1.values[1]).ctor === "Inquire.AND") {
                    return _ps.Algebra["|&|"](booleanAlgebraInquire({}))(_1.values[2])(_1.values[0]);
                };
            };
            if (_1.ctor === "Inquire.Junc") {
                if ((_1.values[1]).ctor === "Inquire.OR") {
        ...
        var distribute = function (_1) {
            if (_1.ctor === "Inquire.Junc") {
                if ((_1.values[1]).ctor === "Inquire.AND") {
                    if ((_1.values[2]).ctor === "Inquire.Junc") {
                        if (((_1.values[2]).values[1]).ctor === "Inquire.OR") {
                            return _ps.Algebra["|&|"](booleanAlgebraInquire({}))(_ps.Algebra["|||"](booleanAlgebraInquire({}))(_1.values[0])((_1.values[2]).values[0]))(_ps.Algebra["|||"](booleanAlgebraInquire({}))(_1.values[0])((_1.values[2]).values[2]));
                        };
                    };
                };
            };
        ...
        var equiv = function (_1) {
            return function (_2) {
                return _ps.Algebra["|||"](booleanAlgebraInquire({}))(_ps.Algebra["|&|"](booleanAlgebraInquire({}))(_1)(_2))(_ps.Algebra["|&|"](booleanAlgebraInquire({}))(_ps.Algebra["|~|"](complementedLatticeInquire({}))(_1))(_ps.Algebra["|~|"](complementedLatticeInquire({}))(_2)));
                throw "Failed pattern match";
            };
        };
        module.equiv = equiv;
        var implies = function (_1) {
            return function (_2) {
                return _ps.Algebra["|||"](booleanAlgebraInquire({}))(_ps.Algebra["|~|"](complementedLatticeInquire({}))(_1))(_2);
                throw "Failed pattern match";
            };
        };
        ...
        var or = function (_1) {
            return function (_2) {
                return _ps.Algebra["|||"](booleanAlgebraInquire({}))(_1)(_2);
                throw "Failed pattern match";
            };
        };
        module.or = or;
        var xor = function (_1) {
            return function (_2) {
                return _ps.Algebra["|||"](booleanAlgebraInquire({}))(_ps.Algebra["|&|"](booleanAlgebraInquire({}))(_1)(_ps.Algebra["|~|"](complementedLatticeInquire({}))(_2)))(_ps.Algebra["|&|"](booleanAlgebraInquire({}))(_ps.Algebra["|~|"](complementedLatticeInquire({}))(_1))(_2));
                throw "Failed pattern match";
            };
        };
        module.xor = xor;
        var bitraversableInquire = function (_1) {
            ...
            return {
                bitraverse: function (__dict_Applicative_45) {
                    return bitraversableInquire_bitraverse(__dict_Applicative_45);
                }
            };
        };
        module.bitraversableInquire = bitraversableInquire;
        var bitraversableInquire_bitraverse = function (__dict_Applicative_44) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return function (_3) {
                        if (_3.ctor === "Inquire.EmptyAnd") {
                            return _ps.Prelude.pure(__dict_Applicative_44)(EmptyAnd);
                        };
                        if (_3.ctor === "Inquire.EmptyOr") {
                            return _ps.Prelude.pure(__dict_Applicative_44)(EmptyOr);
                        };
                        if (_3.ctor === "Inquire.Pred") {
                            return _ps.Prelude["<*>"](__dict_Applicative_44)(_ps.Prelude["<*>"](__dict_Applicative_44)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_44))(Pred)(_1(_3.values[0])))(_ps.Prelude.pure(__dict_Applicative_44)(_3.values[1])))(_2(_3.values[2]));
                        };
                        if (_3.ctor === "Inquire.Junc") {
                            return _ps.Prelude["<*>"](__dict_Applicative_44)(_ps.Prelude["<*>"](__dict_Applicative_44)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_44))(Junc)(_ps.Data_Traversable.bitraverse(bitraversableInquire({}))(__dict_Applicative_44)(_1)(_2)(_3.values[0])))(_ps.Prelude.pure(__dict_Applicative_44)(_3.values[1])))(_ps.Data_Traversable.bitraverse(bitraversableInquire({}))(__dict_Applicative_44)(_1)(_2)(_3.values[2]));
                        };
                        if (_3.ctor === "Inquire.Wrap") {
                            return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_44))(Wrap(_3.values[0]))(_ps.Data_Traversable.bitraverse(bitraversableInquire({}))(__dict_Applicative_44)(_1)(_2)(_3.values[1]));
                        };
                        throw "Failed pattern match";
                    };
                };
        ...
        var biFoldableInquire_bifoldl = function (_1) {
            if (typeof _1 !== "function") {
                throw "function expected";
            };
            return function (_2) {
                ...
                return function (_3) {
                    return function (_4) {
                        return _ps.Data_Foldable.bifoldr(biFoldableInquire({}))(_ps.Prelude.flip(_1))(_ps.Prelude.flip(_2))(_3)(_4);
                        throw "Failed pattern match";
                    };
                };
            };
        ...
        var associate = function (_1) {
            if (_1.ctor === "Inquire.Junc") {
                if ((_1.values[1]).ctor === "Inquire.AND") {
                    if ((_1.values[2]).ctor === "Inquire.Junc") {
                        if (((_1.values[2]).values[1]).ctor === "Inquire.AND") {
                            return _ps.Algebra["|&|"](booleanAlgebraInquire({}))(_ps.Algebra["|&|"](booleanAlgebraInquire({}))(_1.values[0])((_1.values[2]).values[0]))((_1.values[2]).values[2]);
                        };
                    };
                };
            };
            ...
            if (_1.ctor === "Inquire.Junc") {
                if ((_1.values[0]).ctor === "Inquire.Junc") {
                    if (((_1.values[0]).values[1]).ctor === "Inquire.AND") {
                        if ((_1.values[1]).ctor === "Inquire.AND") {
                            return _ps.Algebra["|&|"](booleanAlgebraInquire({}))((_1.values[0]).values[0])(_ps.Algebra["|&|"](booleanAlgebraInquire({}))((_1.values[0]).values[2])(_1.values[2]));
                        };
                    };
                };
            };
        ...
        module.and = and;
        var absorb = function (__dict_Eq_46) {
                ...
                return function (_1) {
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[1]).ctor === "Inquire.AND") {
                            if ((_1.values[2]).ctor === "Inquire.Junc") {
                                if (((_1.values[2]).values[1]).ctor === "Inquire.OR") {
                                    if (_ps.Prelude["=="](eqInquire(__dict_Eq_46)(__dict_Eq_47))(_1.values[0])((_1.values[2]).values[0])) {
                                        return _1.values[0];
                                    };
                                };
                            };
    ...
    _ps.Inquire_Combinators = (function (module) {
        ...
        var toObj = function (_1) {
            return (function (_2) {
                return (function (_1) {
                    var updateVals = _1;
                    return (function (_1) {
                        return _ps.Data_Foldable.bifoldr(_ps.Inquire.biFoldableInquire({}))(_1)(updateVals)({
                            keys: [  ], 
                            vals: [  ]
                        })(_2);
                        throw "Failed pattern match";
                        ...
                        return function (o) {
                            ...
                            return _ps.Inquire.objExtend(o)({
                                keys: _ps.Data_Array[":"](k)(o.keys)
                            });
                        };
                    });
                    throw "Failed pattern match";
        ...
        module.toObj = toObj;
        var vals = function (_1) {
            return (toObj(_1)).vals;
            throw "Failed pattern match";
        };
        module.vals = vals;
        var replaceValByVal = function (__dict_Eq_48) {
            return function (_1) {
                return function (_2) {
                    return function (_3) {
                        if (_3.ctor === "Inquire.Pred") {
                            if (_ps.Prelude["=="](__dict_Eq_48)(_2)(_3.values[2])) {
                                return _ps.Inquire.Pred(_3.values[0])(_3.values[1])(_1);
                            };
                        };
                        if (_3.ctor === "Inquire.Junc") {
                            return _ps.Inquire.Junc(replaceValByVal(__dict_Eq_48)(_1)(_2)(_3.values[0]))(_3.values[1])(replaceValByVal(__dict_Eq_48)(_1)(_2)(_3.values[2]));
                        };
                        if (_3.ctor === "Inquire.Wrap") {
                            return _ps.Inquire.Wrap(_3.values[0])(replaceValByVal(__dict_Eq_48)(_1)(_2)(_3.values[1]));
                        };
                        return _3;
                        throw "Failed pattern match";
                    };
        ...
        var replaceValByKey = function (__dict_Eq_49) {
            return function (_1) {
                return function (_2) {
                    return function (_3) {
                        if (_3.ctor === "Inquire.Pred") {
                            if (_ps.Prelude["=="](__dict_Eq_49)(_2)(_3.values[0])) {
                                return _ps.Inquire.Pred(_2)(_3.values[1])(_1);
                            };
                        };
                        if (_3.ctor === "Inquire.Junc") {
                            return _ps.Inquire.Junc(replaceValByKey(__dict_Eq_49)(_1)(_2)(_3.values[0]))(_3.values[1])(replaceValByKey(__dict_Eq_49)(_1)(_2)(_3.values[2]));
                        };
                        if (_3.ctor === "Inquire.Wrap") {
                            return _ps.Inquire.Wrap(_3.values[0])(replaceValByKey(__dict_Eq_49)(_1)(_2)(_3.values[1]));
                        };
                        return _3;
                        throw "Failed pattern match";
                    };
        ...
        var remove$prime = function (__dict_Eq_50) {
            return function (__dict_Eq_51) {
                return function (_1) {
                    ...
                    return function (_2) {
                        return function (_3) {
                            return (function (_4, _5, _6) {
                                if (_6.ctor === "Inquire.Junc") {
                                    return (function (_1) {
                                        return _4(_6.values[2])(_1) ? _ps.Inquire.Junc(remove$prime(__dict_Eq_50)(__dict_Eq_51)(_4)(_5)(_6.values[0]))(_6.values[1])(_6.values[2]) : _ps.Inquire.Junc(_6.values[0])(_6.values[1])(_1);
                                        throw "Failed pattern match";
                                    })(remove$prime(__dict_Eq_50)(__dict_Eq_51)(_4)(_5)(_6.values[2]));
                                };
                                if (_6.ctor === "Inquire.Wrap") {
                                    return _ps.Inquire.Wrap(_6.values[0])(remove$prime(__dict_Eq_50)(__dict_Eq_51)(_4)(_5)(_6.values[1]));
                                };
                                if (_ps.Prelude["=="](_ps.Inquire.eqInquire(__dict_Eq_50)(__dict_Eq_51))(_5)(_6)) {
        ...
        var removeAll = function (__dict_Eq_52) {
            return function (__dict_Eq_53) {
                return remove$prime(__dict_Eq_52)(__dict_Eq_53)(function (x) {
                    return function (y) {
                        return true;
                    };
                });
        ...
        var remove = function (__dict_Eq_54) {
            return function (__dict_Eq_55) {
                return remove$prime(__dict_Eq_54)(__dict_Eq_55)(_ps.Prelude["=="](_ps.Inquire.eqInquire(__dict_Eq_54)(__dict_Eq_55)));
            };
        };
        module.remove = remove;
        var keys = function (_1) {
            return (toObj(_1)).keys;
            throw "Failed pattern match";
        };
        module.keys = keys;
        var toArrayObj = function (_1) {
        ...
        var toTuple = function (_1) {
            return _ps.Data_Tuple.zip(keys(_1))(vals(_1));
            throw "Failed pattern match";
        };
        ...
        var findByVal = function (__dict_Eq_56) {
            return function (_1) {
                return function (_2) {
                    if (_2.ctor === "Inquire.Pred") {
                        if (_ps.Prelude["=="](__dict_Eq_56)(_1)(_2.values[2])) {
                    ...
                    if (_2.ctor === "Inquire.Junc") {
                        return _ps.Data_Maybe.maybe(findByVal(__dict_Eq_56)(_1)(_2.values[0]))(_ps.Data_Maybe.Just)(findByVal(__dict_Eq_56)(_1)(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Wrap") {
                        return findByVal(__dict_Eq_56)(_1)(_2.values[1]);
                    };
                    return _ps.Data_Maybe.Nothing;
                    throw "Failed pattern match";
                };
        ...
        var findByKey = function (__dict_Eq_57) {
            return function (_1) {
                return function (_2) {
                    if (_2.ctor === "Inquire.Pred") {
                        if (_ps.Prelude["=="](__dict_Eq_57)(_1)(_2.values[0])) {
                    ...
                    if (_2.ctor === "Inquire.Junc") {
                        return _ps.Data_Maybe.maybe(findByKey(__dict_Eq_57)(_1)(_2.values[0]))(_ps.Data_Maybe.Just)(findByKey(__dict_Eq_57)(_1)(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Wrap") {
                        return findByKey(__dict_Eq_57)(_1)(_2.values[1]);
                    };
                    return _ps.Data_Maybe.Nothing;
                    throw "Failed pattern match";
                };
    ...
    _ps.Inquire_Zipper = (function (module) {
        ...
        var zipMost = function (_1) {
            return function (_2) {
                return _ps.Data_Maybe.maybe(_2)(zipMost(_1))(_1(_2));
                throw "Failed pattern match";
            };
        };
        ...
        var modify = function (_1) {
            ...
            return function (_2) {
                return Zip(Object.extend(_2.values[0], {
                    hole: _1((_2.values[0]).hole)
                }));
                throw "Failed pattern match";
            };
        };
        ...
        var query = function (_1) {
            if (typeof _1 !== "function") {
                throw "function expected";
            };
            return (function (_2) {
                return _ps.Prelude["<<<"](_ps.Prelude.categoryArr({}))(_2)(getHole);
                throw "Failed pattern match";
            })(_1);
        };
        module.query = query;
