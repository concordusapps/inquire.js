(function (_ps) {
    ...
    _ps.Data_Functor = (function (module) {
        ...
        var first = function (__dict_BiFunctor_7) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return (function (_2) {
                    return $less$dollar$dollar$greater(__dict_BiFunctor_7)(_2)(_ps.Prelude.id(_ps.Prelude.categoryArr({})));
                    throw "Failed pattern match";
                })(_1);
            };
        };
    ...
    _ps.Data_Either = (function (module) {
        ...
        module.Right = Right;
        var showEither_show = function (__dict_Show_8) {
            return function (__dict_Show_9) {
                return function (_1) {
                    if (_1.ctor === "Data.Either.Left") {
                        return "Left " + _ps.Prelude.show(__dict_Show_8)(_1.values[0]);
                    };
                    if (_1.ctor === "Data.Either.Right") {
                        return "Right " + _ps.Prelude.show(__dict_Show_9)(_1.values[0]);
                    };
                    throw "Failed pattern match";
                };
            };
    ...
    _ps.Data_Array = (function (module) {
        ...
        var showArray_show = function (__dict_Show_10) {
            return function (_1) {
                if (!Array.isArray(_1)) {
                    throw "Array expected";
                };
                return (function (_2) {
                    return "[" + joinWith(map(_ps.Prelude.show(__dict_Show_10))(_2))(",") + "]";
                    throw "Failed pattern match";
                })(_1);
            };
        };
    ...
    _ps.Data_Monoid = (function (module) {
        ...
        var mconcat = function (__dict_Monoid_11) {
            return _ps.Data_Array.foldl($less$greater(__dict_Monoid_11))(mempty(__dict_Monoid_11));
        };
    ...
    _ps.Data_Foldable = (function (module) {
        ...
        var foldMap = function (__dict_Foldable_12) {
            return function (__dict_Monoid_13) {
                return function (_1) {
                    ...
                    return function (_2) {
                        return foldr(__dict_Foldable_12)(_ps.Prelude["<<<"](_ps.Prelude.categoryArr({}))(_ps.Data_Monoid["<>"](__dict_Monoid_13))(_1))(_ps.Data_Monoid.mempty(__dict_Monoid_13))(_2);
                        throw "Failed pattern match";
                    };
                };
            };
    ...
    _ps.Data_Traversable = (function (module) {
        ...
        var sequence = function (__dict_Applicative_14) {
            return function (__dict_Traversable_15) {
                return function (_1) {
                    return traverse(__dict_Traversable_15)(__dict_Applicative_14)(_ps.Prelude.id(_ps.Prelude.categoryArr({})))(_1);
                    throw "Failed pattern match";
                };
            };
        };
        module.sequence = sequence;
        var bisequence = function (__dict_Applicative_16) {
            return function (__dict_BiTraversable_17) {
                return function (_1) {
                    return bitraverse(__dict_BiTraversable_17)(__dict_Applicative_16)(_ps.Prelude.id(_ps.Prelude.categoryArr({})))(_ps.Prelude.id(_ps.Prelude.categoryArr({})))(_1);
                    throw "Failed pattern match";
                };
            };
        };
    ...
    _ps.Data_Tuple = (function (module) {
        ...
        var showTuple_show = function (__dict_Show_18) {
            return function (__dict_Show_19) {
                return function (_1) {
                    return "Tuple(" + _ps.Prelude.show(__dict_Show_18)(_1.values[0]) + ", " + _ps.Prelude.show(__dict_Show_19)(_1.values[1]) + ")";
                    throw "Failed pattern match";
                };
            };
        };
    ...
    _ps.Debug_Trace = (function (module) {
        ...
        var print = function (__dict_Show_20) {
            return function (_1) {
                return trace(_ps.Prelude.show(__dict_Show_20)(_1));
                throw "Failed pattern match";
            };
        };
        module.print = print;
    ...
    _ps.Control_Monad = (function (module) {
        var when = function (__dict_Monad_21) {
            return function (_1) {
                if (typeof _1 !== "boolean") {
                    throw "boolean expected";
                };
                return function (_2) {
                    ...
                    if (!_1) {
                        return _ps.Prelude["return"](__dict_Monad_21)({});
                    };
                    throw "Failed pattern match";
                };
            };
        ...
        module.when = when;
        var sequence = function (__dict_Monad_22) {
            return function (_1) {
                if (!Array.isArray(_1)) {
                    throw "Array expected";
                };
                return (function (_2) {
                    if (_2.length === 0) {
                        return _ps.Prelude["return"](__dict_Monad_22)([  ]);
                    };
                    if (_2.length > 0) {
                        var _4 = _2.slice(1);
                        return _ps.Prelude[">>="](__dict_Monad_22)(_2[0])(function (a) {
                            return _ps.Prelude[">>="](__dict_Monad_22)(sequence(__dict_Monad_22)(_4))(function (as) {
                                if (!Array.isArray(as)) {
                                    throw "Array expected";
                                };
                                return _ps.Prelude["return"](__dict_Monad_22)(_ps.Data_Array[":"](a)(as));
                            });
                        });
                    };
                    throw "Failed pattern match";
        ...
        module.sequence = sequence;
        var zipWithM = function (__dict_Monad_23) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return function (_3) {
                        ...
                        return (function (_4, _5, _6) {
                            return sequence(__dict_Monad_23)(_ps.Data_Array.zipWith(_4)(_5)(_6));
                            throw "Failed pattern match";
                        })(_1, _2, _3);
                    };
                };
        ...
        var replicateM = function (__dict_Monad_24) {
            return function (_1) {
                ...
                return function (_2) {
                    ...
                    return _ps.Prelude[">>="](__dict_Monad_24)(_2)(function (a) {
                        return _ps.Prelude[">>="](__dict_Monad_24)(replicateM(__dict_Monad_24)(_1 - 1)(_2))(function (as) {
                            if (!Array.isArray(as)) {
                                throw "Array expected";
                            };
        ...
        var mapM = function (__dict_Monad_25) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return (function (_3, _4) {
                        if (_4.length === 0) {
                            return _ps.Prelude["return"](__dict_Monad_25)([  ]);
                        };
                        if (_4.length > 0) {
                            var _6 = _4.slice(1);
                            return _ps.Prelude[">>="](__dict_Monad_25)(_3(_4[0]))(function (b) {
                                return _ps.Prelude[">>="](__dict_Monad_25)(mapM(__dict_Monad_25)(_3)(_6))(function (bs) {
                                    if (!Array.isArray(bs)) {
                                        throw "Array expected";
                                    };
                                    return _ps.Prelude["return"](__dict_Monad_25)(_ps.Data_Array[":"](b)(bs));
                                });
                            });
                        };
                        throw "Failed pattern match";
        ...
        module.mapM = mapM;
        var join = function (__dict_Monad_26) {
            return function (_1) {
                return _ps.Prelude[">>="](__dict_Monad_26)(_1)(function (m) {
                    return m;
                });
                throw "Failed pattern match";
            };
            ...
            return function (_1) {
                ...
                return function (_2) {
                    return function (_3) {
                        ...
                        return (function (_4, _5, _6) {
                            if (_6.length === 0) {
                                return _ps.Prelude["return"](__dict_Monad_27)(_5);
                            };
                            if (_6.length > 0) {
                                var _8 = _6.slice(1);
                                return _ps.Prelude[">>="](__dict_Monad_27)(_4(_5)(_6[0]))(function (a$prime) {
                                    return foldM(__dict_Monad_27)(_4)(a$prime)(_8);
                                });
                            };
                            throw "Failed pattern match";
                        })(_1, _2, _3);
        ...
        module.foldM = foldM;
        var $greater$eq$greater = function (__dict_Monad_28) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return function (_3) {
                        return _ps.Prelude[">>="](__dict_Monad_28)(_1(_3))(function (b) {
                            return _2(b);
                        });
                        throw "Failed pattern match";
                    };
        ...
        var $less$eq$less = function (__dict_Monad_29) {
            return _ps.Prelude.flip($greater$eq$greater(__dict_Monad_29));
        };
        module["<=<"] = $less$eq$less;
        return module;
    })(_ps.Control_Monad || {});
    ...
    _ps.Inquire = (function (module) {
        ...
        var traversableInquire = function (_1) {
            ...
            return {
                traverse: function (__dict_Applicative_31) {
                    return traversableInquire_traverse(__dict_Applicative_31);
                }
            };
        };
        module.traversableInquire = traversableInquire;
        var traversableInquire_traverse = function (__dict_Applicative_30) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    if (_2.ctor === "Inquire.EmptyAnd") {
                        return _ps.Prelude.pure(__dict_Applicative_30)(EmptyAnd);
                    };
                    if (_2.ctor === "Inquire.EmptyOr") {
                        return _ps.Prelude.pure(__dict_Applicative_30)(EmptyOr);
                    };
                    if (_2.ctor === "Inquire.Pred") {
                        return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_30))(Pred(_2.values[0])(_2.values[1]))(_1(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Junc") {
                        return _ps.Prelude["<*>"](__dict_Applicative_30)(_ps.Prelude["<*>"](__dict_Applicative_30)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_30))(Junc)(_ps.Data_Traversable.traverse(traversableInquire({}))(__dict_Applicative_30)(_1)(_2.values[0])))(_ps.Prelude.pure(__dict_Applicative_30)(_2.values[1])))(_ps.Data_Traversable.traverse(traversableInquire({}))(__dict_Applicative_30)(_1)(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Wrap") {
                        return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_30))(Wrap(_2.values[0]))(_ps.Data_Traversable.traverse(traversableInquire({}))(__dict_Applicative_30)(_1)(_2.values[1]));
                    };
                    throw "Failed pattern match";
                };
            };
        ...
        var showInquire_show = function (__dict_Show_32) {
            return function (__dict_Show_33) {
                return function (_1) {
                    ...
                    if (_1.ctor === "Inquire.Pred") {
                        return _ps.Prelude.show(__dict_Show_32)(_1.values[0]) + _ps.Prelude.show(showRel({}))(_1.values[1]) + _ps.Prelude.show(__dict_Show_33)(_1.values[2]);
                    };
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[0]).ctor === "Inquire.Pred") {
                            if ((_1.values[2]).ctor === "Inquire.Pred") {
                                return _ps.Prelude.show(showInquire(__dict_Show_32)(__dict_Show_33))(_1.values[0]) + _ps.Prelude.show(showJuncOp({}))(_1.values[1]) + _ps.Prelude.show(showInquire(__dict_Show_32)(__dict_Show_33))(_1.values[2]);
                            };
                        };
                    };
                    if (_1.ctor === "Inquire.Junc") {
                        ...
                        if ((_1.values[0]).ctor === "Inquire.Junc") {
                            if ((_1.values[2]).ctor === "Inquire.Junc") {
                                if (_ps.Prelude["=="](eqJuncOp({}))((_1.values[0]).values[1])(_1.values[1]) && _ps.Prelude["=="](eqJuncOp({}))(_1.values[1])((_1.values[2]).values[1])) {
                                    return _ps.Prelude.show(showInquire(__dict_Show_32)(__dict_Show_33))(_1.values[0]) + _ps.Prelude.show(showJuncOp({}))((_1.values[0]).values[1]) + _ps.Prelude.show(showInquire(__dict_Show_32)(__dict_Show_33))(_1.values[2]);
                                };
                            };
                        };
                    };
                    ...
                    if (_1.ctor === "Inquire.Wrap") {
                        if ((_1.values[0]).ctor === "Inquire.NOBOOL") {
                            if ((_1.values[1]).ctor === "Inquire.Wrap") {
                                return _ps.Prelude.show(showInquire(__dict_Show_32)(__dict_Show_33))(_1.values[1]);
                            };
                        };
                    };
                    if (_1.ctor === "Inquire.Wrap") {
                    ...
                    if (_1.ctor === "Inquire.Wrap") {
                        return _ps.Prelude.show(showWrapOp({}))(_1.values[0]) + "(" + _ps.Prelude.show(showInquire(__dict_Show_32)(__dict_Show_33))(_1.values[1]) + ")";
                    };
                    throw "Failed pattern match";
                };
            };
        ...
        var gen = function (__dict_Show_36) {
            return function (__dict_Show_37) {
                return function (_1) {
                    return _ps.Prelude.show(showInquire(__dict_Show_36)(__dict_Show_37))(_1);
                    throw "Failed pattern match";
                };
            };
        };
        ...
        var eqInquire_$eq$eq = function (__dict_Eq_38) {
            return function (__dict_Eq_39) {
                return function (_1) {
                    return function (_2) {
                        if (_1.ctor === "Inquire.EmptyAnd") {
                            if (_2.ctor === "Inquire.EmptyAnd") {
                        ...
                        if (_1.ctor === "Inquire.Pred") {
                            if (_2.ctor === "Inquire.Pred") {
                                return _ps.Prelude["=="](__dict_Eq_38)(_1.values[0])(_2.values[0]) && _ps.Prelude["=="](eqRel({}))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](__dict_Eq_39)(_1.values[2])(_2.values[2]);
                            };
                        };
                        if (_1.ctor === "Inquire.Junc") {
                            if (_2.ctor === "Inquire.Junc") {
                                return _ps.Prelude["=="](eqInquire(__dict_Eq_38)(__dict_Eq_39))(_1.values[0])(_2.values[0]) && _ps.Prelude["=="](eqJuncOp({}))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](eqInquire(__dict_Eq_38)(__dict_Eq_39))(_1.values[2])(_2.values[2]);
                            };
                        };
                        if (_1.ctor === "Inquire.Wrap") {
                            if (_2.ctor === "Inquire.Wrap") {
                                return _ps.Prelude["=="](eqInquire(__dict_Eq_38)(__dict_Eq_39))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](eqWrapOp({}))(_1.values[0])(_2.values[0]);
                            };
                        };
                        return false;
                        throw "Failed pattern match";
        ...
        var eqInquire_$div$eq = function (__dict_Eq_40) {
            return function (__dict_Eq_41) {
                return function (_1) {
                    return function (_2) {
                        return !_ps.Prelude["=="](eqInquire(__dict_Eq_40)(__dict_Eq_41))(_1)(_2);
                        throw "Failed pattern match";
                    };
                };
            };
        ...
        var idempotent = function (__dict_Eq_34) {
            return function (__dict_Eq_35) {
                return function (_1) {
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[1]).ctor === "Inquire.AND") {
                            if (_ps.Prelude["=="](eqInquire(__dict_Eq_34)(__dict_Eq_35))(_1.values[0])(_1.values[2])) {
                                return _1.values[0];
                            };
                        };
                    };
        ...
        var bitraversableInquire = function (_1) {
            ...
            return {
                bitraverse: function (__dict_Applicative_43) {
                    return bitraversableInquire_bitraverse(__dict_Applicative_43);
                }
            };
        };
        module.bitraversableInquire = bitraversableInquire;
        var bitraversableInquire_bitraverse = function (__dict_Applicative_42) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return function (_3) {
                        if (_3.ctor === "Inquire.EmptyAnd") {
                            return _ps.Prelude.pure(__dict_Applicative_42)(EmptyAnd);
                        };
                        if (_3.ctor === "Inquire.EmptyOr") {
                            return _ps.Prelude.pure(__dict_Applicative_42)(EmptyOr);
                        };
                        if (_3.ctor === "Inquire.Pred") {
                            return _ps.Prelude["<*>"](__dict_Applicative_42)(_ps.Prelude["<*>"](__dict_Applicative_42)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_42))(Pred)(_1(_3.values[0])))(_ps.Prelude.pure(__dict_Applicative_42)(_3.values[1])))(_2(_3.values[2]));
                        };
                        if (_3.ctor === "Inquire.Junc") {
                            return _ps.Prelude["<*>"](__dict_Applicative_42)(_ps.Prelude["<*>"](__dict_Applicative_42)(_ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_42))(Junc)(_ps.Data_Traversable.bitraverse(bitraversableInquire({}))(__dict_Applicative_42)(_1)(_2)(_3.values[0])))(_ps.Prelude.pure(__dict_Applicative_42)(_3.values[1])))(_ps.Data_Traversable.bitraverse(bitraversableInquire({}))(__dict_Applicative_42)(_1)(_2)(_3.values[2]));
                        };
                        if (_3.ctor === "Inquire.Wrap") {
                            return _ps.Prelude["<$>"](_ps.Prelude.functorFromApplicative(__dict_Applicative_42))(Wrap(_3.values[0]))(_ps.Data_Traversable.bitraverse(bitraversableInquire({}))(__dict_Applicative_42)(_1)(_2)(_3.values[1]));
                        };
                        throw "Failed pattern match";
                    };
                };
        ...
        module.and = and;
        var absorb = function (__dict_Eq_44) {
                ...
                return function (_1) {
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[1]).ctor === "Inquire.AND") {
                            if ((_1.values[2]).ctor === "Inquire.Junc") {
                                if (((_1.values[2]).values[1]).ctor === "Inquire.OR") {
                                    if (_ps.Prelude["=="](eqInquire(__dict_Eq_44)(__dict_Eq_45))(_1.values[0])((_1.values[2]).values[0])) {
                                        return _1.values[0];
                                    };
                                };
                            };
    ...
    _ps.Inquire_Combinators = (function (module) {
        function unsafeFind(v) {  return function(i) {    /* We use String's eq typeclass because it uses `unsafeRefEq`*/    return find(_ps.Prelude.eqString({}))(v)(i);  }};
        module.unsafeFind = unsafeFind;
                        ...
                        return function (_3) {
                            return (function (_4, _5, _6) {
                                if (_6.ctor === "Inquire.Junc") {
                                    return (function (_1) {
                                        return _4(_6.values[2])(_1) ? _ps.Inquire.Junc(remove$prime(__dict_Eq_46)(__dict_Eq_47)(_4)(_5)(_6.values[0]))(_6.values[1])(_6.values[2]) : _ps.Inquire.Junc(_6.values[0])(_6.values[1])(_1);
                                        throw "Failed pattern match";
                                    })(remove$prime(__dict_Eq_46)(__dict_Eq_47)(_4)(_5)(_6.values[2]));
                                };
                                if (_6.ctor === "Inquire.Wrap") {
                                    return _ps.Inquire.Wrap(_6.values[0])(remove$prime(__dict_Eq_46)(__dict_Eq_47)(_4)(_5)(_6.values[1]));
                                };
                                if (_ps.Prelude["=="](_ps.Inquire.eqInquire(__dict_Eq_46)(__dict_Eq_47))(_5)(_6)) {
        ...
        var find = function (__dict_Eq_52) {
            return function (_1) {
                return function (_2) {
                    if (_2.ctor === "Inquire.Pred") {
                    ...
                    if (_2.ctor === "Inquire.Junc") {
                        return _ps.Data_Maybe.maybe(find(__dict_Eq_52)(_1)(_2.values[0]))(_ps.Data_Maybe.Just)(find(__dict_Eq_52)(_1)(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Wrap") {
                        return find(__dict_Eq_52)(_1)(_2.values[1]);
                    };
                    return _ps.Data_Maybe.Nothing;
                    throw "Failed pattern match";
                };
        ...
        var filterVals = function (_1) {
            ...
            return function (_2) {
                ...
                if (_2.ctor === "Inquire.Junc") {
                    return _ps.Inquire.Junc(filterVals(_1)(_2.values[0]))(_2.values[1])(filterVals(_1)(_2.values[2]));
                };
                if (_2.ctor === "Inquire.Wrap") {
                    return _ps.Inquire.Wrap(_2.values[0])(filterVals(_1)(_2.values[1]));
                };
                return _2;
                throw "Failed pattern match";
            };
        };
        module.filterVals = filterVals;
        return module;
