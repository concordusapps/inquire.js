(function(){
  'use strict';
  var Parser, empty, arity, grammar, Inquire, toString$ = {}.toString;
  ...
  grammar = {
    ...
    bnf: {
      ...
      q: [['( q )', '$$ = { arity: "1", bool: "", value: $2 };'], ['VAR rel VAR', '$$ = { arity: "2", rel: $2, left: $1, right: $3 };'], ['q binaryBool q', '$$ = { arity: "2", bool: $2, left: $1, right: $3 };'], ['unaryBool q', '$$ = { arity: "1", bool: $1, value: $2 };']],
