  ...
  Inquire = (function(){
    ...
    */
    prototype._analyze = function(key, val, arg$){
      var ref$, arity, ref1$, op;
      ref$ = arg$ != null
        ? arg$
        : {}, arity = (ref1$ = ref$.arity) != null ? ref1$ : '2', op = (ref1$ = ref$.op) != null ? ref1$ : '=';
      switch (ref$ = [key], false) {
      case !(function(it){
        return it instanceof Inquire;
      })(ref$[0]):
        this._handleInquire.apply(this, arguments);
        break;
      case !compose$([
          (function(it){
            return it === 'Array';
        ...
        this._handleArray.apply(this, arguments);
        break;
      case !compose$([
          (function(it){
            return it === 'String';
      ...
      case !compose$([
        ...
        this._handleObject.apply(this, arguments);
      }
      return this;
    };
    prototype._binary = function(key, val, options){
      if (this._empty(this.inquiry)) {
        ...
        return this.inquiry = {
          ...
          left: this.inquiry,
          right: (function(func, args, ctor) {
            ctor.prototype = func.prototype;
            var child = new ctor, result = func.apply(child, args), t;
            return (t = typeof result)  == "object" || t == "function" ? result || child : child;
  })(Inquire, arguments, function(){}).inquiry
        };
      }
    };
    prototype._handleArray = function(array, arg$, options){
      var inquire, boolean, i$, len$, item, op;
      inquire = Inquire();
      boolean = (function(){
        var ref$;
        switch (ref$ = [options.op], false) {
        case ';' !== ref$[0]:
          return 'or';
        default:
          return 'and';
      ...
      if (this._empty(this.inquiry)) {
        op = options.op === '!' ? options.op : '';
        return this._unary(inquire, null, {
          arity: '1',
          op: op
        });
      } else {
        return this._binary(inquire, null, options);
      }
    };
    prototype._handleInquire = function(inquire, arg$, options){
      var op;
      if (this._empty(this.inquiry)) {
        op = options.op === '!' ? options.op : '';
        return this._unary(inquire, null, {
    ...
    prototype._handleObject = function(object, arg$, options){
      var inquire, key, val, op;
      inquire = Inquire();
      for (key in object) {
        val = object[key];
        inquire.eq(key, val);
    ...
    */
    ...
    prototype._genHelper = function(I){
      ...
      if (toString$.call(I).slice(8, -1) === 'String') {
        ...
        case '1' !== ref$[0]:
          return I.op + "(" + this._genHelper(I.value.inquiry) + ")";
        case '2' !== ref$[0]:
