(function (_ps) {
    ...
    _ps.Data_Either = (function (module) {
        ...
        module.Right = Right;
        var showEither_show = function (__dict_Show_6) {
    ...
    _ps.Data_Array = (function (module) {
        ...
        var showArray_show = function (__dict_Show_8) {
            return function (_1) {
                if (!Array.isArray(_1)) {
                    throw "Array expected";
                };
    ...
    _ps.Data_Foldable = (function (module) {
        ...
        var foldMap = function (__dict_Foldable_10) {
            return function (__dict_Monoid_11) {
                return function (_1) {
                    ...
                    return function (_2) {
                        return foldr(__dict_Foldable_10)(_ps.Prelude["<<<"](_ps.Prelude.categoryArr({}))(_ps.Data_Monoid["<>"](__dict_Monoid_11))(_1))(_ps.Data_Monoid.mempty(__dict_Monoid_11))(_2);
                        throw "Failed pattern match";
                    };
                };
            };
    ...
    _ps.Data_Tuple = (function (module) {
        ...
        var showTuple_show = function (__dict_Show_12) {
            return function (__dict_Show_13) {
                return function (_1) {
                    return "Tuple(" + _ps.Prelude.show(__dict_Show_12)(_1.values[0]) + ", " + _ps.Prelude.show(__dict_Show_13)(_1.values[1]) + ")";
                    throw "Failed pattern match";
                };
            };
        };
    ...
    _ps.Debug_Trace = (function (module) {
        ...
        var print = function (__dict_Show_14) {
            return function (_1) {
                return trace(_ps.Prelude.show(__dict_Show_14)(_1));
                throw "Failed pattern match";
            };
        };
        module.print = print;
    ...
    _ps.Control_Monad = (function (module) {
        var when = function (__dict_Monad_15) {
            return function (_1) {
                if (typeof _1 !== "boolean") {
                    throw "boolean expected";
                };
        ...
        module.when = when;
        var sequence = function (__dict_Monad_16) {
            return function (_1) {
                if (!Array.isArray(_1)) {
                    throw "Array expected";
                };
                return (function (_2) {
                    ...
                    if (_2.length > 0) {
                        var _4 = _2.slice(1);
                        return _ps.Prelude[">>="](__dict_Monad_16)(_2[0])(function (a) {
                            return _ps.Prelude[">>="](__dict_Monad_16)(sequence(__dict_Monad_16)(_4))(function (as) {
                                if (!Array.isArray(as)) {
                                    throw "Array expected";
                                };
                                return _ps.Prelude["return"](__dict_Monad_16)(_ps.Data_Array[":"](a)(as));
                            });
                        });
                    };
                    throw "Failed pattern match";
        ...
        var zipWithM = function (__dict_Monad_17) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return function (_3) {
                        ...
                        return (function (_4, _5, _6) {
                            return sequence(__dict_Monad_17)(_ps.Data_Array.zipWith(_4)(_5)(_6));
                            throw "Failed pattern match";
                        })(_1, _2, _3);
                    };
                };
        ...
        var replicateM = function (__dict_Monad_18) {
            return function (_1) {
                ...
                return function (_2) {
                    if (_1 === 0) {
                        return _ps.Prelude["return"](__dict_Monad_18)([  ]);
                    };
                    return _ps.Prelude[">>="](__dict_Monad_18)(_2)(function (a) {
                        return _ps.Prelude[">>="](__dict_Monad_18)(replicateM(__dict_Monad_18)(_1 - 1)(_2))(function (as) {
                            if (!Array.isArray(as)) {
                                throw "Array expected";
                            };
                            return _ps.Prelude["return"](__dict_Monad_18)(_ps.Data_Array[":"](a)(as));
                        });
                    });
                    throw "Failed pattern match";
                };
        ...
        var mapM = function (__dict_Monad_19) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return (function (_3, _4) {
                        ...
                        if (_4.length > 0) {
                            var _6 = _4.slice(1);
                            return _ps.Prelude[">>="](__dict_Monad_19)(_3(_4[0]))(function (b) {
                                return _ps.Prelude[">>="](__dict_Monad_19)(mapM(__dict_Monad_19)(_3)(_6))(function (bs) {
                                    if (!Array.isArray(bs)) {
                                        throw "Array expected";
                                    };
                                    return _ps.Prelude["return"](__dict_Monad_19)(_ps.Data_Array[":"](b)(bs));
                                });
                            });
                        };
                        throw "Failed pattern match";
        ...
        module.mapM = mapM;
        var join = function (__dict_Monad_20) {
            return function (_1) {
                return _ps.Prelude[">>="](__dict_Monad_20)(_1)(function (m) {
                    return m;
                });
                throw "Failed pattern match";
            };
            ...
            return function (_1) {
                ...
                return function (_2) {
                    return function (_3) {
                        ...
                        return (function (_4, _5, _6) {
                            if (_6.length === 0) {
                                return _ps.Prelude["return"](__dict_Monad_21)(_5);
                            };
                            if (_6.length > 0) {
                                var _8 = _6.slice(1);
                                return _ps.Prelude[">>="](__dict_Monad_21)(_4(_5)(_6[0]))(function (a$prime) {
                                    return foldM(__dict_Monad_21)(_4)(a$prime)(_8);
                                });
                            };
                            throw "Failed pattern match";
                        })(_1, _2, _3);
        ...
        module.foldM = foldM;
        var $greater$eq$greater = function (__dict_Monad_22) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return function (_3) {
                        return _ps.Prelude[">>="](__dict_Monad_22)(_1(_3))(function (b) {
                            return _2(b);
                        });
                        throw "Failed pattern match";
                    };
        ...
        var $less$eq$less = function (__dict_Monad_23) {
            return _ps.Prelude.flip($greater$eq$greater(__dict_Monad_23));
        };
        module["<=<"] = $less$eq$less;
        return module;
    })(_ps.Control_Monad || {});
    ...
    _ps.Inquire = (function (module) {
        ...
        var showInquire_show = function (__dict_Show_24) {
            return function (__dict_Show_25) {
                return function (_1) {
                    ...
                    if (_1.ctor === "Inquire.Pred") {
                        return _ps.Prelude.show(__dict_Show_24)(_1.values[0]) + _ps.Prelude.show(showRel({}))(_1.values[1]) + _ps.Prelude.show(__dict_Show_25)(_1.values[2]);
                    };
                    if (_1.ctor === "Inquire.Junc") {
                        return "(" + _ps.Prelude.show(showInquire(__dict_Show_24)(__dict_Show_25))(_1.values[0]) + ")" + _ps.Prelude.show(showJuncOp({}))(_1.values[1]) + "(" + _ps.Prelude.show(showInquire(__dict_Show_24)(__dict_Show_25))(_1.values[2]) + ")";
                    };
                    if (_1.ctor === "Inquire.Wrap") {
                        return _ps.Prelude.show(showWrapOp({}))(_1.values[0]) + "(" + _ps.Prelude.show(showInquire(__dict_Show_24)(__dict_Show_25))(_1.values[1]) + ")";
                    };
                    throw "Failed pattern match";
                };
            };
        ...
        module.gt = gt;
        var gen = function (__dict_Show_28) {
            return function (__dict_Show_29) {
                return function (_1) {
                    return _ps.Prelude.show(showInquire(__dict_Show_28)(__dict_Show_29))(_1);
                    throw "Failed pattern match";
                };
            };
        };
        ...
        var eqInquire_$eq$eq = function (__dict_Eq_30) {
            return function (__dict_Eq_31) {
                return function (_1) {
                    return function (_2) {
                        ...
                        if (_1.ctor === "Inquire.Pred") {
                            if (_2.ctor === "Inquire.Pred") {
                                return _ps.Prelude["=="](__dict_Eq_30)(_1.values[0])(_2.values[0]) && _ps.Prelude["=="](eqRel({}))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](__dict_Eq_31)(_1.values[2])(_2.values[2]);
                            };
                        };
                        if (_1.ctor === "Inquire.Junc") {
                            if (_2.ctor === "Inquire.Junc") {
                                return _ps.Prelude["=="](eqInquire(__dict_Eq_30)(__dict_Eq_31))(_1.values[0])(_2.values[0]) && _ps.Prelude["=="](eqJuncOp({}))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](eqInquire(__dict_Eq_30)(__dict_Eq_31))(_1.values[2])(_2.values[2]);
                            };
                        };
                        if (_1.ctor === "Inquire.Wrap") {
                            if (_2.ctor === "Inquire.Wrap") {
                                return _ps.Prelude["=="](eqInquire(__dict_Eq_30)(__dict_Eq_31))(_1.values[1])(_2.values[1]) && _ps.Prelude["=="](eqWrapOp({}))(_1.values[0])(_2.values[0]);
                            };
                        };
                        return false;
                        throw "Failed pattern match";
        ...
        var eqInquire_$div$eq = function (__dict_Eq_32) {
            return function (__dict_Eq_33) {
                return function (_1) {
                    return function (_2) {
                        return !_ps.Prelude["=="](eqInquire(__dict_Eq_32)(__dict_Eq_33))(_1)(_2);
                        throw "Failed pattern match";
                    };
                };
            };
        ...
        var idempotent = function (__dict_Eq_26) {
            return function (__dict_Eq_27) {
                return function (_1) {
                    if (_1.ctor === "Inquire.Junc") {
                        if ((_1.values[1]).ctor === "Inquire.AND") {
                            if (_ps.Prelude["=="](eqInquire(__dict_Eq_26)(__dict_Eq_27))(_1.values[0])(_1.values[2])) {
                                return _1.values[0];
                            };
                        };
                    };
    ...
    _ps.Inquire_Combinators = (function (module) {
        function find(v) {  return function(i) {    /* We use String's eq typeclass because it uses `unsafeRefEq`*/    return findI(_ps.Prelude.eqString({}))(v)(i);  }};
        module.find = find;
        function remove(i1) {  return function(i2) {    /* We use String's eq typeclass because it uses `unsafeRefEq`*/    return removeI(_ps.Prelude.eqString({}))(_ps.Prelude.eqString({}))(i1)(i2);  }};
        module.remove = remove;
        function removeAll(i1) {  return function(i2) {    /* We use String's eq typeclass because it uses `unsafeRefEq`*/    return removeAllI(_ps.Prelude.eqString({}))(_ps.Prelude.eqString({}))(i1)(i2);  }};
        ...
        module.vals = vals;
        var remove$prime = function (__dict_Eq_36) {
                        ...
                        return function (_3) {
                            return (function (_4, _5, _6) {
                                if (_6.ctor === "Inquire.Junc") {
                                    return (function (_1) {
                                        return _4(_6.values[2])(_1) ? _ps.Inquire.Junc(remove$prime(__dict_Eq_36)(__dict_Eq_37)(_4)(_5)(_6.values[0]))(_6.values[1])(_6.values[2]) : _ps.Inquire.Junc(_6.values[0])(_6.values[1])(_1);
                                        throw "Failed pattern match";
                                    })(remove$prime(__dict_Eq_36)(__dict_Eq_37)(_4)(_5)(_6.values[2]));
                                };
                                if (_6.ctor === "Inquire.Wrap") {
                                    return _ps.Inquire.Wrap(_6.values[0])(remove$prime(__dict_Eq_36)(__dict_Eq_37)(_4)(_5)(_6.values[1]));
                                };
                                if (_ps.Prelude["=="](_ps.Inquire.eqInquire(__dict_Eq_36)(__dict_Eq_37))(_5)(_6)) {
        ...
        var removeAllI = function (__dict_Eq_38) {
            return function (__dict_Eq_39) {
                return remove$prime(__dict_Eq_38)(__dict_Eq_39)(function (x) {
                    return function (y) {
                        return true;
                    };
                });
        ...
        module.removeAllI = removeAllI;
        var removeI = function (__dict_Eq_40) {
            return function (__dict_Eq_41) {
                return remove$prime(__dict_Eq_40)(__dict_Eq_41)(_ps.Prelude["=="](_ps.Inquire.eqInquire(__dict_Eq_40)(__dict_Eq_41)));
            };
        };
        module.removeI = removeI;
        ...
        var findI = function (__dict_Eq_42) {
            return function (_1) {
                return function (_2) {
                    if (_2.ctor === "Inquire.Pred") {
                        if (_ps.Prelude["=="](__dict_Eq_42)(_1)(_2.values[2])) {
                    ...
                    if (_2.ctor === "Inquire.Junc") {
                        return _ps.Data_Maybe.maybe(findI(__dict_Eq_42)(_1)(_2.values[0]))(_ps.Data_Maybe.Just)(findI(__dict_Eq_42)(_1)(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Wrap") {
                        return findI(__dict_Eq_42)(_1)(_2.values[1]);
                    };
                    return _ps.Data_Maybe.Nothing;
                    throw "Failed pattern match";
                };
