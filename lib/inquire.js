(function (_ps) {
    ...
    _ps.Inquire_Combinators = (function (module) {
        ...
        var find = function (__dict_Eq_48) {
            return function (_1) {
                return function (_2) {
                    if (_2.ctor === "Inquire.Pred") {
                    ...
                    if (_2.ctor === "Inquire.Junc") {
                        return _ps.Data_Maybe.maybe(find(__dict_Eq_48)(_1)(_2.values[0]))(_ps.Data_Maybe.Just)(find(__dict_Eq_48)(_1)(_2.values[2]));
                    };
                    if (_2.ctor === "Inquire.Wrap") {
                        return find(__dict_Eq_48)(_1)(_2.values[1]);
                    };
                    return _ps.Data_Maybe.Nothing;
                    throw "Failed pattern match";
                };
