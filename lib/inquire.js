(function (_ps) {
            ...
            return function (__dict_Show_29) {
                return function (_1) {
                    ...
                    if (_1.ctor === "Inquire.Pred") {
                        return encodeURIComponent(_ps.Prelude.show(__dict_Show_28)(_1.values[0])) + _ps.Prelude.show(showRel({}))(_1.values[1]) + encodeURIComponent(_ps.Prelude.show(__dict_Show_29)(_1.values[2]));
                    };
    ...
    _ps.Data_Tuple = (function (module) {
        ...
        var eqTuple_$eq$eq = function (__dict_Eq_44) {
            return function (__dict_Eq_45) {
                return function (_1) {
                    return function (_2) {
                        return _ps.Prelude["=="](__dict_Eq_44)(_1.values[0])(_2.values[0]) && _ps.Prelude["=="](__dict_Eq_45)(_1.values[1])(_2.values[1]);
                        throw "Failed pattern match";
                    };
                };
            };
        ...
        var eqTuple_$div$eq = function (__dict_Eq_46) {
            return function (__dict_Eq_47) {
                return function (t1) {
                    return function (t2) {
                        return !_ps.Prelude["=="](eqTuple(__dict_Eq_46)(__dict_Eq_47))(t1)(t2);
                    };
                };
            };
        };
                ...
                return function (_1) {
                    ...
                    return function (_2) {
                        return function (_3) {
                            if (_3.ctor === "Inquire.Junc") {
                                return (function (r$prime) {
                                    return _1(_3.values[2])(r$prime) ? _ps.Inquire.Junc(remove$prime(__dict_Eq_50)(__dict_Eq_51)(_1)(_2)(_3.values[0]))(_3.values[1])(_3.values[2]) : _ps.Inquire.Junc(_3.values[0])(_3.values[1])(r$prime);
                                })(remove$prime(__dict_Eq_50)(__dict_Eq_51)(_1)(_2)(_3.values[2]));
                            };
                            if (_3.ctor === "Inquire.Wrap") {
                                return _ps.Inquire.Wrap(_3.values[0])(remove$prime(__dict_Eq_50)(__dict_Eq_51)(_1)(_2)(_3.values[1]));
                            };
                            if (_ps.Prelude["=="](_ps.Inquire.eqInquire(__dict_Eq_50)(__dict_Eq_51))(_2)(_3)) {
    ...
    _ps.Debug_Trace = (function (module) {
        ...
        var print = function (__dict_Show_58) {
            return function (o) {
                return trace(_ps.Prelude.show(__dict_Show_58)(o));
            };
        };
        module.print = print;
        module.trace = trace;
    ...
    _ps.Control_Monad = (function (module) {
        ...
        var sequence = function (__dict_Monad_60) {
            return function (_1) {
                if (!Array.isArray(_1)) {
                    throw "Array expected";
                };
                return (function (_2) {
                    if (_2.length === 0) {
                        return _ps.Prelude["return"](__dict_Monad_60)([  ]);
                    };
                    if (_2.length > 0) {
                        var _4 = _2.slice(1);
                        return _ps.Prelude[">>="](__dict_Monad_60)(_2[0])(function (a) {
                            return _ps.Prelude[">>="](__dict_Monad_60)(sequence(__dict_Monad_60)(_4))(function (as) {
                                if (!Array.isArray(as)) {
                                    throw "Array expected";
                                };
                                return _ps.Prelude["return"](__dict_Monad_60)(_ps.Data_Array[":"](a)(as));
                            });
                        });
                    };
                    throw "Failed pattern match";
        ...
        var zipWithM = function (__dict_Monad_61) {
            return function (f) {
                if (typeof f !== "function") {
                    throw "function expected";
                };
                return function (xs) {
                    ...
                    return function (ys) {
                        ...
                        return sequence(__dict_Monad_61)(_ps.Data_Array.zipWith(f)(xs)(ys));
                    };
                };
            };
        };
        var replicateM = function (__dict_Monad_62) {
            return function (_1) {
                if (typeof _1 !== "number") {
                    throw "number expected";
                };
                return function (_2) {
                    if (_1 === 0) {
                        return _ps.Prelude["return"](__dict_Monad_62)([  ]);
                    };
                    return _ps.Prelude[">>="](__dict_Monad_62)(_2)(function (a) {
                        return _ps.Prelude[">>="](__dict_Monad_62)(replicateM(__dict_Monad_62)(_1 - 1)(_2))(function (as) {
                            if (!Array.isArray(as)) {
                                throw "Array expected";
                            };
                            return _ps.Prelude["return"](__dict_Monad_62)(_ps.Data_Array[":"](a)(as));
                        });
                    });
                    throw "Failed pattern match";
                };
        ...
        var mapM = function (__dict_Monad_63) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    ...
                    return (function (_3, _4) {
                        if (_4.length === 0) {
                            return _ps.Prelude["return"](__dict_Monad_63)([  ]);
                        };
                        if (_4.length > 0) {
                            var _6 = _4.slice(1);
                            return _ps.Prelude[">>="](__dict_Monad_63)(_3(_4[0]))(function (b) {
                                return _ps.Prelude[">>="](__dict_Monad_63)(mapM(__dict_Monad_63)(_3)(_6))(function (bs) {
                                    if (!Array.isArray(bs)) {
                                        throw "Array expected";
                                    };
                                    return _ps.Prelude["return"](__dict_Monad_63)(_ps.Data_Array[":"](b)(bs));
                                });
                            });
                        };
                        throw "Failed pattern match";
        ...
        var join = function (__dict_Monad_64) {
            return function (mm) {
                return _ps.Prelude[">>="](__dict_Monad_64)(mm)(function (m) {
                    return m;
                });
            };
        };
        var foldM = function (__dict_Monad_65) {
            return function (_1) {
                if (typeof _1 !== "function") {
                    throw "function expected";
                };
                return function (_2) {
                    return function (_3) {
                        ...
                        return (function (_4, _5, _6) {
                            if (_6.length === 0) {
                                return _ps.Prelude["return"](__dict_Monad_65)(_5);
                            };
                            if (_6.length > 0) {
                                var _8 = _6.slice(1);
                                return _ps.Prelude[">>="](__dict_Monad_65)(_4(_5)(_6[0]))(function (a$prime) {
                                    return foldM(__dict_Monad_65)(_4)(a$prime)(_8);
                                });
                            };
                            throw "Failed pattern match";
                        })(_1, _2, _3);
        ...
        var $greater$eq$greater = function (__dict_Monad_66) {
            return function (f) {
                if (typeof f !== "function") {
                    throw "function expected";
                };
                return function (g) {
                    ...
                    return function (a) {
                        return _ps.Prelude[">>="](__dict_Monad_66)(f(a))(function (b) {
                            return g(b);
                        });
                    };
                };
        ...
        var $less$eq$less = function (__dict_Monad_67) {
            return _ps.Prelude.flip($greater$eq$greater(__dict_Monad_67));
        };
